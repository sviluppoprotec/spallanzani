...
namespace TheSite.Gestione
{
	...
	{	
		...
		protected S_Controls.S_ComboBox S_cmbMagazzino;
		protected S_Controls.S_ComboBox S_CmbUnita;
		...
		private void Ricerca()
		{
			...
			this.S_CmbUnita.DBDefaultValue="0";
			this.S_cmbMagazzino.DBDefaultValue="0";
		...
		private void BindUnita()
		{
			...
			{				
				this.S_CmbUnita.DataSource = Classi.GestoreDropDownList.ItemBlankDataSource(
					_MyDs.Tables[0], "DESCRIZIONE_COD","IDUNITA", "- Selezionare Unità di Misura -", "0");
				this.S_CmbUnita.DataTextField = "DESCRIZIONE_COD";
				this.S_CmbUnita.DataValueField = "IDUNITA";
				this.S_CmbUnita.DataBind();
			}			
		...
		private void BindMagazzino()
		{
			...
			S_cmbMagazzino.Items.Clear();
		
			Classi.ClassiAnagrafiche.ListaMateriali _ListaMateriali = new TheSite.Classi.ClassiAnagrafiche.ListaMateriali();
			DataSet _MyDs = _ListaMateriali.GetMagazzino().Copy();
			  
			if (_MyDs.Tables[0].Rows.Count > 0)
			{				
				this.S_cmbMagazzino.DataSource = Classi.GestoreDropDownList.ItemBlankDataSource(
					_MyDs.Tables[0], "DESCRIZIONE","ID", "- Selezionare Magazzino -", "0");
				this.S_cmbMagazzino.DataTextField = "DESCRIZIONE";
				this.S_cmbMagazzino.DataValueField = "ID";
