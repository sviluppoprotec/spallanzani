	...
	<body onbeforeunload="parent.left.valorizza()" MS_POSITIONING="GridLayout">
		...
		<form id="Form1" method="post" runat="server">
			<TABLE id="TableMain" style="Z-INDEX: 101; POSITION: absolute; WIDTH: 100%; HEIGHT: 100%; TOP: 0px; LEFT: 0px"
				...
				<TR>
					<TD align="left">Unità di Misura
						<asp:RequiredFieldValidator id="rfvUnita" runat="server" ErrorMessage="Selezionare l'Unità di Misura!" ControlToValidate="cmbUnita"
