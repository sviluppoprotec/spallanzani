...
namespace TheSite.Gestione
{
	...
	/// </summary>
		...
		public class EditMateriale : System.Web.UI.Page
		{
			...
			protected S_Controls.S_ComboBox cmbmagazzino;			
				...
				if (!Page.IsPostBack )
				{
					...
					if (itemId != 0) 
					{
						...
						{					
							...
							if (_Dr["id_magazzino"] != DBNull.Value)
								this.cmbmagazzino.SelectedValue= _Dr["id_magazzino"].ToString();
			...
			private void BindMagazzino()
			{
				...
				if (_MyDs.Tables[0].Rows.Count > 0)
				{				
					this.cmbmagazzino.DataSource = Classi.GestoreDropDownList.ItemBlankDataSource(
						_MyDs.Tables[0], "DESCRIZIONE","ID", "- Selezionare Magazzino -", "0");
					this.cmbmagazzino.DataTextField = "DESCRIZIONE";
					this.cmbmagazzino.DataValueField = "ID";
					this.cmbmagazzino.DataBind();
				}
				}		
			...
			{	
				...
				this.txtDescMateriale.DBDefaultValue = DBNull.Value;
				this.cmbUnita.DBDefaultValue = "-1";
				this.cmbmagazzino.DBDefaultValue="0";
