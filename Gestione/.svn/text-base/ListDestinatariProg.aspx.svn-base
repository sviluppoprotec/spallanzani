<%@ Page language="c#" Codebehind="ListDestinatariProg.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.ListDestinatariProg" %>
								...
								<TD>
									<cc1:DataPanel id="DataPanel1" runat="server" TitleStyle-CssClass="TitleSearch" Collapsed="False"
										...
										<TABLE id="tblSearch100" cellSpacing="0" cellPadding="0" width="100%" border="0">
											...
											<tr><td>&nbsp;</td></tr>
											<TR>
												<TD>Abilitazione Email:
													<asp:DropDownList id="CmbsAbilitati" runat="server">
														<asp:ListItem Value="1">Si</asp:ListItem>
														<asp:ListItem Value="0">No</asp:ListItem>
													</asp:DropDownList></TD>
												<TD>Tipo Programmazione:
													<asp:DropDownList id="CmbsProgrammazione" runat="server">
												...
												<TD>Utente
													<asp:TextBox id="txtUtente" runat="server" Width="150px"></asp:TextBox>
												</TD>
											</TR>
											<tr><td>&nbsp;</td></tr>
										</TABLE>
									...
									<asp:DataGrid id="DataGrid1" runat="server" CssClass="DataGrid" Width="100%" BorderColor="Gray"
										...
										<Columns>
											<asp:TemplateColumn>
												...
												<ItemTemplate>
													<a href='EditDestinatarioProg.aspx?ItemID=<%# DataBinder.Eval(Container.DataItem,"id") + "&FunId=" + _SiteModule.ModuleId+ "&TipoProg=" + DataBinder.Eval(Container.DataItem,"Cod_Prog")%>'>
											...
											<asp:BoundColumn DataField="tipo_prog" HeaderText="Tipo Prog"></asp:BoundColumn>
