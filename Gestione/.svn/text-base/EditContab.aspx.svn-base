...
<%@ Page language="c#" Codebehind="EditContab.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.EditContab" %>
									...
									<TD vAlign="top" align="left"><asp:panel id="PanelEdit" runat="server">
											<TABLE id="tblSearch75" border="0" cellSpacing="1" cellPadding="2">
												<TR>
													...
													<TD>
														<P>
															<cc1:S_TextBox id="txtsdescrizione" tabIndex="1" runat="server" Width="396px" MaxLength="255" DBIndex="1"
												...
												<TR>
													...
													Servizio
													<TD>
														<CC1:S_COMBOBOX style="Z-INDEX: 0" id="cmbsServizio" tabIndex="2" runat="server" Width="304px" DBIndex="2"
															DBParameterName="p_id_servizio" DBSize="10" DBDirection="Input" DBDataType="Integer"></CC1:S_COMBOBOX></TD>
												</TR>
											</TABLE>
										</asp:panel></TD>
								</TR>
