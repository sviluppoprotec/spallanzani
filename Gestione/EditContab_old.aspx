...
<%@ Page language="c#" Codebehind="EditContab_old.aspx.cs" AutoEventWireup="false" Inherits="TheSite.Gestione.EditContab_old" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Aggiorna Tipo Intervento</title>
								...
								<TR>
									...
									<TD vAlign="top" align="left"><asp:panel id="PanelEdit" runat="server">
											<TABLE id="tblSearch75" cellSpacing="1" cellPadding="2" border="0">
												<TR>
													<TD style="WIDTH: 178px; HEIGHT: 23px" align="left">Descrizione
														<asp:RequiredFieldValidator id="rfvEqstd" runat="server" ControlToValidate="txtsdescrizione" ErrorMessage="La Descrizione Breve è obbligatoria">*</asp:RequiredFieldValidator></TD>
													<TD style="HEIGHT: 23px">
														<cc1:S_TextBox id="txtsdescrizione" tabIndex="2" runat="server" Width="90%" DBDataType="VarChar"
															DBDirection="Input" DBSize="50" DBParameterName="p_descrizione" DBIndex="1" MaxLength="255"></cc1:S_TextBox></TD>
												</TR>
											</TABLE>
										</asp:panel></TD>
								</TR>
