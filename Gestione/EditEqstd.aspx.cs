...
{	
	...
	/// </summary>
	public class EditEqstd : System.Web.UI.Page
	{
		...
		protected S_Controls.S_TextBox S_UNI1;
		protected S_Controls.S_TextBox S_UNI2;
		protected S_Controls.S_TextBox S_UNI3;
		protected S_Controls.S_TextBox S_UNI4;
		protected S_Controls.S_TextBox S_UNI5;
		protected S_Controls.S_TextBox S_UNI6;
		protected S_Controls.S_TextBox S_UNI7;
			...
			if (!Page.IsPostBack )
			{
				...
				if (itemId != 0) 
				{
					...
					{					
						...
						if (_Dr["uni1"] != DBNull.Value)
							this.S_UNI1.Text = (string) _Dr["uni1"].ToString();
						if (_Dr["uni2"] != DBNull.Value)
							this.S_UNI2.Text = (string) _Dr["uni2"].ToString();
						if (_Dr["uni3"] != DBNull.Value)
							this.S_UNI3.Text = (string) _Dr["uni3"].ToString();
						if (_Dr["uni4"] != DBNull.Value)
							this.S_UNI4.Text = (string) _Dr["uni4"].ToString();
						if (_Dr["uni5"] != DBNull.Value)
							this.S_UNI5.Text = (string) _Dr["uni5"].ToString();
						if (_Dr["uni6"] != DBNull.Value)
							this.S_UNI6.Text = (string) _Dr["uni6"].ToString();
						if (_Dr["uni7"] != DBNull.Value)
							this.S_UNI7.Text = (string) _Dr["uni7"].ToString();
