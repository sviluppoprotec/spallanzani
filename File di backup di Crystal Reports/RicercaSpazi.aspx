				...
				<TR>
					<TD vAlign="top" align="center"><cc2:datapanel id="DataPanel1" runat="server" TitleStyle-CssClass="TitleSearch" Collapsed="False"
							...
							<TABLE id="tblForm" cellSpacing="1" cellPadding="1" align="center">
								...
								<TR vAlign="top">
									<TD align="center">
										<TABLE style="HEIGHT: 95px" id="tabl" class="tblSearch100Dettaglio" border="0" cellSpacing="0"
											...
											<TR>
												<TD colSpan="2">
													<TABLE border="0" width="100%">
														<TR>
															<TD style="WIDTH: 14.88%"><SPAN>Stanza:</SPAN></TD>
															<TD>
											...
											<TR>
												<TD style="WIDTH: 131px; HEIGHT: 26px"><SPAN>Macroarea:</SPAN></TD>
											...
											<TR>
												<TD style="WIDTH: 131px; HEIGHT: 20px">Destinazione uso:</TD>
												<TD style="HEIGHT: 20px">
													<cc1:S_TextBox id="s_txtDestinazione" runat="server" Width="344px"></cc1:S_TextBox>&nbsp;<INPUT style="WIDTH: 32px; HEIGHT: 25px" id=bt_destinazione class=btn onclick="apri_ricerca_uso('ADMIN','<%= descUso1 %>','<%= Usoid1 %>');" value=... type=button name=bt_destinazione><INPUT id="chkDestinazione" type="checkbox" name="chkDestinazione" runat="server">Spuntare 
													per visualizzare il campo nella lista</TD>
											</TR>
											<TR>
												...
												<TD style="HEIGHT: 27px">
													<cc1:S_TextBox id="s_txtReparto" runat="server" Width="344px" Visible="False"></cc1:S_TextBox>&nbsp;
													<INPUT style="WIDTH: 32px; HEIGHT: 25px" id=bt_reparto class=btn onclick="apri_ricerca_reparto('ADMIN','<%= descRep%>','<%= id%>');" value=... type=button name=bt_reparto>
													<INPUT id="chkReparto" type="checkbox" name="chkReparto" runat="server">Spuntare 
													per visualizzare il campo nella lista</TD>
											</TR>-->
											<TR>
												<TD style="HEIGHT: 4px" colSpan="2" align="center">&nbsp; Edifici Selezionati
												</TD>
											</TR>
											<TR>
											...
											<TR>
												<TD colSpan="2" align="left">
													<TABLE style="WIDTH: 100%; HEIGHT: 19px" id="Table1" border="0" cellSpacing="0" cellPadding="0"
														width="448">
														<TR>
															<TD align="right">
															...
															<TD style="WIDTH: 159px">&nbsp;
																<cc1:S_Button id="S_btExcel" runat="server" CssClass="btn" Width="134px" Text="Exp Excel" ToolTip="Esportazione Dati Excel"></cc1:S_Button></TD>
															<TD style="WIDTH: 159px">&nbsp;
				...
				<TR>
					<TD><asp:panel id="Panel1" runat="server" Height="7px">
							...
							<asp:DataGrid id="DtgRicercaSpazi" runat="server" CssClass="DataGrid" Width="100%" PageSize="20"
								...
								BorderWidth="1px" BorderStyle="None" BorderColor="Gray" ShowFooter="True" AllowCustomPaging="True">
								...
								<Columns>
									...
									<asp:BoundColumn DataField="CATEGORIA" HeaderText="Macroarea"></asp:BoundColumn>
									<asp:BoundColumn DataField="DESTINAZIONE" HeaderText="Destinazione uso"></asp:BoundColumn>
									<asp:BoundColumn DataField="VALORE_INT" HeaderText="Mq" DataFormatString="{0:#,##0.00}">
										<ItemStyle HorizontalAlign="Right"></ItemStyle>
									</asp:BoundColumn>
									<asp:BoundColumn DataField="VALORE_mc" HeaderText="Mc" DataFormatString="{0:#,##0.00}">
										<ItemStyle HorizontalAlign="Right"></ItemStyle>
									</asp:BoundColumn>
								</Columns>
