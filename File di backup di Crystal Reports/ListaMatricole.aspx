<%@ Page language="c#" Codebehind="ListaMatricole.aspx.cs" AutoEventWireup="false" Inherits="TheSite.CommonPage.ListaMatricole" %>
					...
					<TD>
						...
						<asp:DataGrid id="DataGrid1" runat="server" Width="100%" PageSize="10" BorderColor="Gray" BorderStyle="None"
							...
							<Columns>
								...
								<asp:BoundColumn DataField="var_matricola" HeaderText="Matricola"></asp:BoundColumn>
							</Columns>
