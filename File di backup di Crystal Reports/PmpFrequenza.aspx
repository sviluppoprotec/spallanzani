									...
									<TD Align="center">
										<Collapse:DataPanel id="PanelRicerca" runat="server" ExpandImageUrl="../Images/down.gif" CollapseImageUrl="../Images/up.gif"
											...
											<TABLE id="tblSearch100" cellSpacing="1" cellPadding="2" border="0">
												<TR>
													<TD align="left" width="20%">Frequenza</TD>
													<TD width="20%">
														<cc1:S_TextBox id="txtsFrequenza" runat="server" DBSize="40" width="100%" DBDirection="Input" DBParameterName="p_frequenza"
															DBIndex="0"></cc1:S_TextBox></TD>
													<TD align="left" width="20%">Descrizione</TD>
													<TD width="40%">
														<cc1:S_TextBox id="txtsFrequenza_des" runat="server" DBSize="50" width="90%" DBDirection="Input"
															DBParameterName="p_frequenza_des" DBIndex="1"></cc1:S_TextBox></TD>
												</TR>
												<TR>
													<TD align="left" colSpan="1" rowSpan="1">Tipo Cadenza</TD>
													<TD>
														<cc1:s_combobox id="CmbCadenza" runat="server" DBDirection="Input" DBParameterName="p_tipo" DBIndex="3"
															DBDataType="Integer">
