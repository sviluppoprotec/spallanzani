				...
				<Choice Filter="isHTML32" Xmlns="Mobile HTML3.2 Template">
					<ContentTemplate>
						<TABLE id="testata" style="BORDER-RIGHT: darkgray 1px solid; BORDER-TOP: darkgray 1px solid; FONT-SIZE: 11px; BORDER-LEFT: #666666 1px solid; WIDTH: 100%; COLOR: #000077; BORDER-BOTTOM: darkgray 1px solid; FONT-FAMILY: Verdana, Arial; BACKGROUND-COLOR: whitesmoke"
							...
							<TR>
								<TD align="center" bgColor="#3399cc" colSpan="2"><B>Ricerca RdL/OdL da Completare</B></TD>
							</TR>
						  </table>
						...
						<TABLE id="Table11" style="BORDER-RIGHT: darkgray 1px solid; BORDER-TOP: darkgray 1px solid; FONT-SIZE: 11px; BORDER-LEFT: #666666 1px solid; WIDTH: 100%; COLOR: #000077; BORDER-BOTTOM: darkgray 1px solid; FONT-FAMILY: Verdana, Arial; BACKGROUND-COLOR: whitesmoke"
							...
							<tr> <TD> RdL </TD></tr>
							<tr> <TD> <mobile:TextBox id="txtRichiesta" runat="server" Size="15" Numeric="True"></mobile:TextBox> </TD></tr>
							
							<tr> <TD align="left"> OdL </TD></tr>
							<tr> <TD> <mobile:TextBox id="txtOrdineLavoro" runat="server" Size="15"></mobile:TextBox> </TD></tr>
							
							<tr> <TD> Data Creazione RdL  </TD></tr>
							<tr> <TD> <asp:TextBox id="txtDataCreazione" runat="server" Columns="15" Enabled="False" ReadOnly="True"></asp:TextBox> <mobile:Command id="Command1" onclick="OnDataSelect" runat="server">...</mobile:Command></TD></tr>
							
							<tr> <TD align="left"> Richiedente </TD></tr>
							<tr> <TD align="left"> <mobile:TextBox id="txtRichiedente" runat="server" Size="15"></mobile:TextBox> <mobile:Command id="RicercaRichiedente" onclick="OnRicercaRichiedente" runat="server">...</mobile:Command></TD></tr>
							
							<tr> <TD align="left"> Gruppo </TD></tr>
							<tr> <TD align="left"> <asp:DropDownList id="cmbsGruppo" runat="server"></asp:DropDownList> </TD></tr>
							<tr> <TD align="left"> Descrizione </TD></tr>
							<tr> <TD align="left"> <mobile:TextBox id="txtDescrizione" runat="server" Size="15"></mobile:TextBox> </TD></tr>
							<tr> <TD align="left"> Servizio </TD></tr>
							<tr> <TD align="left"> <asp:DropDownList id="cmbsServizio" runat="server" Width="100%"></asp:DropDownList> </TD></tr>
							<tr> <TD align="left"> Urgenza </TD></tr>
							<tr> <TD align="left"> <asp:DropDownList id="cmbsPriority" runat="server" Width="100%"></asp:DropDownList> </TD></tr>
							<tr> <TD>
							...
							<TR>
								<TD colSpan="4">
									<mobile:RegularExpressionValidator id="ValidatorOrdine" runat="server" ErrorMessage='Il campo "OdL" deve essere un Numero'
										ControlToValidate="txtOrdineLavoro" ValidationExpression="\d{0,}"></mobile:RegularExpressionValidator>
									<mobile:RegularExpressionValidator id="ValidatorRichiesta" runat="server" ErrorMessage='Il campo "RdL" deve essere un Numero'
			...
			<mobile:DeviceSpecific id="DeviceSpecific1" runat="server">
				<Choice Filter="isHTML32" Xmlns="http://schemas.microsoft.com/mobile/html32template">
					<ContentTemplate>
							...
							<TABLE id="testatagriglia" style="BORDER-RIGHT: darkgray 1px solid; BORDER-TOP: darkgray 1px solid; FONT-SIZE: 11px; BORDER-LEFT: #666666 1px solid; WIDTH: 100%; COLOR: #000077; BORDER-BOTTOM: darkgray 1px solid; FONT-FAMILY: Verdana, Arial; BACKGROUND-COLOR: whitesmoke"
							cellSpacing="1" cellPadding="1" width="100%" border="0">
							<TR>
								<TD align="center" bgColor="#3399cc" colSpan="2"><B>Ricerca RdL/OdL da Completare</B></TD>
							</TR>
							...
							<TR>
								<TD colSpan="2">
									<asp:datagrid id="DataGridEdifici" runat="server" Width="100%" Height="50%" PageSize="5" BorderColor="Gray"
										...
										<Columns>
											<asp:TemplateColumn HeaderText="Codice Edificio">
												<ItemTemplate>
