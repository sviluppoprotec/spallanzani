	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" style="Z-INDEX: 101; POSITION: absolute; TOP: 8px; LEFT: 8px" cellSpacing="0"
				...
				<TR>
					<TD><asp:datagrid id="DataGrid1" runat="server" Width="100%" PageSize="5" DataKeyField="materiali_id"
							GridLines="Vertical" AllowPaging="True" CssClass="DataGrid" AutoGenerateColumns="False" CellPadding="4"
							BackColor="White" BorderWidth="1px" BorderStyle="None" BorderColor="Gray">
							...
							<Columns>
								...
								<asp:BoundColumn DataField="codice" HeaderText="Codice Materiale"></asp:BoundColumn>
								<asp:BoundColumn DataField="magazzino" HeaderText="Magazzino"></asp:BoundColumn>
							</Columns>
