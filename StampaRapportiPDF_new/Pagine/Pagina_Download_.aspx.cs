...
using System.IO;
using System.Text;
using TheSite.StampaRapportiPDF_new.Schemixsd;
...
namespace StampaRapportiPDF_new.Pagine
{
	...
	/// </summary>
	public class Pagina_Download_ : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			pgtlDownoloadStampe.MainTitle = "Download File Report MP";
		...
		{
			TheSite.StampaRapportiPDF_new.Schemixsd.DatasetReport ds;
		...
		private TheSite.StampaRapportiPDF_new.Schemixsd.DatasetReport riempiDatasetDettaglio(string id)
		{
			AgganciaDatalayer io_db  = new AgganciaDatalayer();
			S_ControlsCollection clDatiRicerca = new S_ControlsCollection();
			int index=0;
		...
		private void riempiSchedaDettaglio(TheSite.StampaRapportiPDF_new.Schemixsd.DatasetReport ds)
		{
