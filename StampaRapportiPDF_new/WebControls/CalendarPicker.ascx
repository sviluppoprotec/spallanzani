<%@ Control Language="c#" AutoEventWireup="false" Codebehind="CalendarPicker.ascx.cs" Inherits="StampaRapportiPDF_new.WebControls.CalendarPicker" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
