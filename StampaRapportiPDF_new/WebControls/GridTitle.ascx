<%@ Control Language="c#" AutoEventWireup="false" Codebehind="GridTitle.ascx.cs" Inherits="StampaRapportiPDF_new.WebControls.GridTitle" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
