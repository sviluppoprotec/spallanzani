namespace TheSite.WebControls
{
	...
	/// </summary>
	public class UserStanzeRic : System.Web.UI.UserControl
	{
		...
		private void ShowFramest(int NumDirectory)
		{
			...
			_StrBld.Append("document.getElementById(\"docstanza\").src=\"" + dir + "CommonPage/ListaStanzeRic.aspx?codstanza=\" + ctrl2 + idUsercontrol1;\n");  
