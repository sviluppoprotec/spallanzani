...
<TABLE id="TableMain" border="0" cellSpacing="0" cellPadding="0" width="100%" align="left">
	<TR>
...
<asp:label id="lblTot1" runat="server" Height="0px" Width="0px"></asp:label>
