namespace TheSite.WebControls
{
	...
	/// <summary>
	///		Descrizione di riepilogo per AggiungiReclamo.
	/// </summary>
	public class AggiungiReclamo : System.Web.UI.UserControl
	{
			...
			private void Page_Load(object sender, System.EventArgs e)
			{
				...
				btsCodice.Attributes.Add("onclick","ShowFrameAddReclamo('" + idTextCod + "'," + q + ",event);");  
				
				
				Classi.SiteJavaScript.ShowFrameReclamo(Page,1);   
