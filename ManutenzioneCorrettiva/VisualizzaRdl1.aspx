										...
										<TABLE border="0" cellSpacing="1" cellPadding="1" width="100%">
											<TBODY>
												...
												<TR>
													...
													<TD>NOTA/AMBIENTE:</TD>
													<TD><asp:label id="lblNota" runat="server"></asp:label></TD>
												</TR>
												<TR>
													<TD>COMUNE:</TD>
												...
												<TR>
													<TD>DITTA:</TD>
													<TD colSpan="3"><asp:label id="lblDitta" runat="server"></asp:label></TD>
												</TR>
											</TBODY>
										</TABLE>
									</DIV>
									...
									<DIV style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid">
										<TABLE border="0" cellSpacing="1" cellPadding="1" width="100%">
											...
											<TR>
												...
												<TD width="25%"><asp:label id="lblServizio" runat="server"></asp:label></TD>
												<TD width="25%">CENTRO DI COSTO:</TD>
												<TD width="25%"><asp:label id="lblCdC" runat="server"></asp:label></TD>
											</TR>
											<TR>
											...
											<TR>
												<TD width="25%">CAUSA PRESUNTA GUASTO/ANOMALIA:</TD>
												<TD colSpan="3"><asp:label id="LblAnomalia" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD width="25%">EFFETTO DEL GUASTO/ANOMALIA:</TD>
												<TD colSpan="3"><asp:label id="LblEffetto" runat="server"></asp:label></TD>
											</TR>
											<TR>
												<TD width="25%">TIPO MANUTENZIONE:</TD>
												<TD width="25%"><asp:label id="lbltipomanutenzione" runat="server"></asp:label><INPUT style="WIDTH: 8px; HEIGHT: 18px" id="Hidden1" size="1" type="hidden" name="HidTipInter"
														runat="server"></TD>
												<TD width="25%">PROGRAMMABILITA' INTERVENTO:</TD>
												<TD width="25%"><asp:label id="lblTipoIntervento" runat="server"></asp:label><INPUT style="WIDTH: 8px; HEIGHT: 18px" id="HidTipInter" size="1" type="hidden" name="HidTipInter"
														runat="server"></TD>
											</TR>
										</TABLE>
									</DIV>
