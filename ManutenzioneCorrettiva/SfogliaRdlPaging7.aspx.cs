...
namespace TheSite.ManutenzioneCorrettiva
{
	...
	/// </summary>
	public class SfogliaRdlPaging7 :  System.Web.UI.Page
	{
		#region variabili
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string _mypage="./ManutenzioneCorrettiva/SfogliaRdlPaging7.aspx";			
			...
			{	
				...
				if(Context.Handler is TheSite.ManutenzioneCorrettiva.CompletaRdl_CRM || Context.Handler is TheSite.ManutenzioneCorrettiva.EditApprovaEmetti)
				{
					_fp1= Context.Handler as ManutenzioneCorrettiva.CompletaRdl_CRM;
					if (_fp1!=null)
					{
						_myColl= ((ManutenzioneCorrettiva.CompletaRdl_CRM)_fp1)._Contenitore;
...
Classi.ManCorrettiva.MANCORRETTIVASFOGLIARDL _ClManCorrettiva= new TheSite.Classi.ManCorrettiva.MANCORRETTIVASFOGLIARDL();
		...
		private void BindServizio(string CodEdificio)
		{
			if (CodEdificio=="")
			{
				this.cmbsServizio.Items.Add(Classi.GestoreDropDownList.ItemMessaggio("- Selezionare un Servizio-", ""));
				this.cmbsServizio.Items.Add(Classi.GestoreDropDownList.ItemMessaggio("BS-Manutenzione generica", "82"));
				this.cmbsServizio.Items.Add(Classi.GestoreDropDownList.ItemMessaggio("BS-Manutenzione ascensori", "83"));
				this.cmbsServizio.Items.Add(Classi.GestoreDropDownList.ItemMessaggio("BS-Servizi Accessori", "84"));
				this.cmbsServizio.Items.Add(Classi.GestoreDropDownList.ItemMessaggio("BS-Pulizie", "85"));
				this.cmbsServizio.Items.Add(Classi.GestoreDropDownList.ItemMessaggio("BS-Neve", "86"));
			}
//			
//			
//			
...
//				ImageButton _img5 = (ImageButton) e.Item.Cells[18].FindControl("Imagebutton5");
				string appo2 ="CompletaRdl_CRM.aspx?wr_id=' + DataBinder.Eval(Container.DataItem,'WR_ID')" + varapp;
				string appo="CompletaRdl_CRM.ascx?wr_id=' + DataBinder.Eval(Container.DataItem,'WR_ID')" + varapp;
...
//				Classi.ManStraordinaria.ManCorrettivaPaging  _Richiesta = new TheSite.Classi.ManStraordinaria.ManCorrettivaPaging();
		...
		private void DataGridRicerca_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			...
			{	
				string appo2 ="CompletaRdl_CRM.aspx?wr_id=" +(e.Item.Cells[0].Text) +varapp ;
				string appo="CompletaRdl_CRM.aspx?wr_id=" +(e.Item.Cells[0].Text) + varapp ;
				ImageButton _img1 = (ImageButton) e.Item.Cells[1].FindControl("lnkDett");
...
//			}
		...
		{
			Response.Redirect("SfogliaRdlPaging7.aspx?FunID=" + ViewState["FunId"]);
		}
		...
		private void RicercaManRichiesta(bool reset)
		{
			...
			S_Controls.Collections.S_Object s_p_tipomanutenzione_id = new S_Controls.Collections.S_Object();
			s_p_tipomanutenzione_id.ParameterName = "p_tipomanutenzione_id";
			s_p_tipomanutenzione_id.DbType = ApplicationDataLayer.DBType.CustomDBType.Integer;
			s_p_tipomanutenzione_id.Direction = ParameterDirection.Input;
			s_p_tipomanutenzione_id.Size =10;
			s_p_tipomanutenzione_id.Index = _SCollection.Count;
			s_p_tipomanutenzione_id.Value = Int32.Parse(this.cmbsTipoManutenzione.SelectedValue);
			_SCollection.Add(s_p_tipomanutenzione_id);
			...
			if (reset==true)
			{
				...
				int _totalRecords = _Richiesta.GetCount2(_SCollection);
			...
			DataSet _MyDs = _Richiesta.GetSfogliaRDL2(_SCollection).Copy();		
		...
		public DataSet GetWordExcel()
		{
			...
			return  _Richiesta.GetSfogliaRDLExcel_3(_SCollection).Copy();		
		}
		...
		private void DataGridRicerca2_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{ 
				...
				string appo2 ="CompletaRdl_CRM.aspx?wr_id=' + DataBinder.Eval(Container.DataItem,'WR_ID')" + varapp;
				string appo="CompletaRdl.aspx_CRM?wr_id=' + DataBinder.Eval(Container.DataItem,'WR_ID')" + varapp;
