<%@ Page language="c#" Codebehind="CompletaRdl_CRM.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneCorrettiva.CompletaRdl_CRM" %>
									...
									<TR>
										<TD><cc2:datapanel id="PanelGeneral" runat="server" titlestyle-cssclass="TitleSearch" collapsed="False"
												...
												<TABLE id="tblSearch100" border="0" cellSpacing="0" cellPadding="0" width="100%">
													...
													<TR>
														<TD style="HEIGHT: 12px" width="20%"><B>NR CRM:</B></TD>
														<TD>
															<ASP:LABEL id="LblNR_CR" runat="server" width="174px"></ASP:LABEL></TD>
														<TD style="HEIGHT: 12px"></TD>
													</TR>
													<TR>
												...
												-->
													...
													<TR>
														...
														<TD style="HEIGHT: 19px" colSpan="3">
															<CC1:S_COMBOBOX id="cmdsStdApparecchiatura" runat="server" width="480px" dbdatatype="Integer" dbsize="10"
																dbparametername="p_eqstd_id" dbdirection="Input" dbindex="1" AutoPostBack="True"></CC1:S_COMBOBOX></TD>
													</TR>
													<TR>
														<TD><B>Apparecchiatura:</B></TD>
														<TD colSpan="3">
															<CC1:S_COMBOBOX id="cmbEQ" runat="server" width="480px" dbdatatype="Integer" dbsize="10" dbparametername="p_id_eq"
																dbdirection="Input" dbindex="1"></CC1:S_COMBOBOX></TD>
													</TR>
													<TR>
														<TD class="SGA"><B class="blueoverline">Descrizione Intervento/Note:</B></TD>
														<TD colSpan="3">
															<CC1:S_TEXTBOX id="txtsDescrizione" runat="server" width="480px" height="34px" textmode="MultiLine"></CC1:S_TEXTBOX></TD>
													</TR>
													<TR>
														<TD class="SGA"><B class="blueoverline">Causa Presunta Guasto/Anomalia:</B></TD>
														<TD colSpan="3">
															<CC1:S_TEXTBOX id="txtCausa" runat="server" width="480px" height="34px" textmode="MultiLine" MaxLength="408"></CC1:S_TEXTBOX></TD>
													</TR>
													<TR>
														<TD class="SGA"><B class="blueoverline">Effetto del guasto/anomalie sulle prestazioni 
																dell'impianto/infrastuttura:</B></TD>
														<TD colSpan="3">
															<CC1:S_TEXTBOX id="txtEffettoGuasto" runat="server" width="480px" height="34px" textmode="MultiLine"
										...
										<TD><cc2:datapanel id="Datapanel1" runat="server" titlestyle-cssclass="TitleSearch" collapsed="False"
												...
												<TABLE id="Table3" border="0" cellSpacing="1" cellPadding="1" width="100%">
													...
													<TR id="trprev3">
														...
														<TD colSpan="3">
															<CC1:S_TEXTBOX id="txtModalitaPagamento" runat="server" width="480px" height="34px" textmode="MultiLine"
						...
						<TD><cc2:datapanel id="Datapanel3" runat="server" titlestyle-cssclass="TitleSearch" collapsed="False"
								...
								<TABLE id="Table4" border="0" cellSpacing="1" cellPadding="1" width="100%">
									...
									<TR>
										...
										<TD style="HEIGHT: 27px" class="sga" vAlign="middle"><B class="blueoverline">Programmabilità 
												Intervento:</B></TD>
									...
									<TR>
										<TD style="WIDTH: 139px"><B class="blueoverline"> Note:</B></TD>
										<TD colSpan="3">
											<CC1:S_TEXTBOX id="txtNoteSga" runat="server" width="480px" height="34px" textmode="MultiLine"
												MaxLength="408"></CC1:S_TEXTBOX></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 139px"><STRONG></STRONG></TD>
										<TD colSpan="3">
											<asp:Label id="lblSGA" runat="server" Font-Bold="True" Visible="False"></asp:Label>&nbsp;
											<asp:Label id="LblDataInvioSga" runat="server" Font-Bold="True" Visible="False"></asp:Label></TD>
									</TR>
									<TR>
										<TD style="WIDTH: 139px"></TD>
										<TD style="WIDTH: 241px">
											<asp:Button id="BtSalvaSGA" runat="server" Text="Salva/Invia Email" Width="120px"></asp:Button>&nbsp;&nbsp;
										</TD>
										<TD></TD>
										<TD></TD>
									</TR>
							...
							<TR>
								<TD style="WIDTH: 144px" colSpan="6">
									<TABLE style="WIDTH: 616px; HEIGHT: 33px" id="Table12" border="0" cellSpacing="0" cellPadding="0"
										...
										<TR>
											<TD>
												<CC1:S_OPTIONBUTTON id="OptAMisura" tabIndex="4" runat="server" Checked="True" text="A Misura" groupname="Grkind"></CC1:S_OPTIONBUTTON></TD>
											<TD style="WIDTH: 106px">
												<CC1:S_OPTIONBUTTON id="OptAForfait" tabIndex="4" runat="server" text="A Forfait" groupname="Grkind"></CC1:S_OPTIONBUTTON></TD>
				...
				<TD><cc2:datapanel id="Datapanel4" runat="server" titlestyle-cssclass="TitleSearch" collapsed="False"
						...
						<TABLE border="0" cellSpacing="1" cellPadding="1" width="100%">
							...
							<TR>
								...
								<TD style="WIDTH: 329px" colSpan="3">
									<CC1:S_TEXTBOX id="txtNoteCompletamento" runat="server" width="480px" height="34px" textmode="MultiLine"
							...
							<TR>
								<TD style="WIDTH: 144px" class="die"><STRONG class="blueoverline"></STRONG></TD>
								<TD style="WIDTH: 329px" colSpan="3">
									<CC1:S_TEXTBOX id="cmbDescrizioneIntervento" runat="server" width="480px" height="34px" textmode="MultiLine"
										MaxLength="256" Visible="False"></CC1:S_TEXTBOX></TD>
							</TR>
							<TR id="trsod">
					...
					<div id="azioni" class="DataPanel75" runat="server">
						<TABLE border="0" width="100%">
							...
							<TR>
								...
								<TD><asp:button id="BtDIE" runat="server" Text="Salva/Invia DIE" Width="135px" Visible="False"></asp:button></TD>
