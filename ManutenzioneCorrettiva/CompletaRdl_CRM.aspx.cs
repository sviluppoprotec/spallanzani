...
namespace TheSite.ManutenzioneCorrettiva
{
	...
	/// </summary>
	public class CompletaRdl_CRM : System.Web.UI.Page
	{
		#region dichiara
		...
		protected System.Web.UI.WebControls.Label LblNR_CR;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string _mypage="./ManutenzioneCorrettiva/CompletaRdl_CRM.aspx";			
		...
		private void LoadDati()
		{
			...
			DataSet _Ds=  _ClManCorrettiva.GetSingleRdl_DEMO(this.wr_id);
			...
			LblNR_CR.Text= _Dr["nr_crm"].ToString();
