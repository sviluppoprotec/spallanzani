...
//			//
			...
			this.btnsSalva.Attributes.Add("onclick", "verificaSalvataggio();");	
			#endregion
			...
			{		
				...
				cmbsTipoManutenzione.SelectedValue="1";
...
//				}
		...
		{    
			...
			this.cmbsUrgenza.SelectedIndexChanged += new System.EventHandler(this.cmbsUrgenza_SelectedIndexChanged);
		...
		private void BindControls(string Codice)
		{
			...
			if(cmbsUrgenza.SelectedValue.Equals("1"))
			{
				this.lblUrgenza.Text = "Sopralluogo entro 15 minuti se la richiesta è fatta in orario lavorativo oppure Sopralluogo entro 45 minuti se la richiesta è fatta in orario lavorativo";
			}
			else
			{
...
//			{
		...
		{   
			//string b = RicercaModulo1.Idbl;
			int cod= Convert.ToInt32(this.RicercaModulo1.Idbl);
		...
		private void cmbsUrgenza_SelectedIndexChanged(object sender, System.EventArgs e)
		{
			if(cmbsUrgenza.SelectedValue.Equals("1"))
			{
				this.lblUrgenza.Text = "Sopralluogo entro 15 minuti se la richiesta è fatta in orario lavorativo oppure Sopralluogo entro 45 minuti se la richiesta è fatta in orario non lavorativo";
			}
			else
			{
				this.lblUrgenza.Text = "";
