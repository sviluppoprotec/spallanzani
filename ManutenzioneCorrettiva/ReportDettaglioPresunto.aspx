<%@ Page language="c#" Codebehind="ReportDettaglioPresunto.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneCorretiva.ReportDettaglioPresunto" %>
					...
					<TD width="800">
						...
						<TABLE id="Table2" style="WIDTH: 800px; HEIGHT: 34px" cellSpacing="0" cellPadding="0" width="800"
							...
							<asp:repeater id="repeater2" Runat="server">
								<ItemTemplate>
									<tr>
										<td align="right" colspan="<%=colspan%>"><b>TOTALI</b>
										</td>
