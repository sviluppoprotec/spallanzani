									...
									<TR>
										<TD style="HEIGHT: 72%" vAlign="top" align="center"><uc1:gridtitle id="GridTitle1" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca" runat="server" CssClass="DataGrid" BorderColor="Gray" BorderWidth="1px"
												...
												<Columns>
													...
													<asp:BoundColumn DataField="data_approvazione" HeaderText="Data Approvazione"></asp:BoundColumn>
													<asp:BoundColumn DataField="descrizione_approvazione" HeaderText="Stato Approvazione"></asp:BoundColumn>
												</Columns>
