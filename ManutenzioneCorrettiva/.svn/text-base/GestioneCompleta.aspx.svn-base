							...
							<TABLE id="Table3" border="0" cellSpacing="1" cellPadding="1" width="100%">
								...
								<TR>
									<TD colSpan="3" align="left">
										<cc1:S_Button id="S_btMostra" runat="server" Text="Ricerca" ToolTip="Avvia la ricerca"></cc1:S_Button>&nbsp;
										<cc1:S_Button id="S_Btreset" runat="server" Text="Reset" ToolTip="Svuota i campi di ricercca"></cc1:S_Button></TD>
