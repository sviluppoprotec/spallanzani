...
//				} 
				...
				if (e.Item.Cells[13].Text.Trim().Length >20) 
				{
					descrizione=e.Item.Cells[13].Text.Trim().Substring(0,18) + "..."; 
					e.Item.Cells[13].ToolTip=e.Item.Cells[13].Text;
					e.Item.Cells[13].Text=descrizione;
				} 
