	...
	<body MS_POSITIONING="GridLayout">
		<form id="Form1" method="post" runat="server">
			<TABLE id="Table1" cellSpacing="0" cellPadding="0" width="95%" border="0">
				...
				<tr>
					<td>
						<FONT face="Arial" size="3"><b>Cofely Italia spa - SIR INAIL EDIFICIO P.LE PASTORE</b></FONT>
					</td>
				</tr>
				<TR>
					<TD width="100%">
									...
									<TR>
										<TD width="100%">
											<table id="Table10" cellPadding="3" width="90%" border="1" frame="border">
												<tr borderColor="#ffffff">
													<TD colSpan="2"><Font face="Arial" size="1"><nobr>ODL N°:</nobr></Font><b><Font face="Arial" size="-1"><%=WO_Id %>
															</Font></b>
													</TD>
													<TD>
														<cc1:s_label id="S_Lblditta" runat="server"></cc1:s_label></TD>
													<td align="left" colSpan="2"><b><Font face="Arial" size="1"><nobr>RDL N.</nobr></Font>
												...
												<tr bordercolor="#ffffff">
													<td>
														<Font face="Arial" size="1"><b><nobr>DENOMINAZIONE CLIENTE: </nobr></b></Font><strong>
															...
															<Font face="Arial" size="-1">INAIL </Font></strong>
													</td>
													<td align="left">
