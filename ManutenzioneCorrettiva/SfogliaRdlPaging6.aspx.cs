...
namespace TheSite.ManutenzioneCorrettiva
{
	...
	public class SfogliaRdlPaging6 :  System.Web.UI.Page
	{
		...
		protected WebControls.CalendarPicker Calendarpicker40;
		...
		protected S_Controls.S_ComboBox S_Solleciti;
		protected S_Controls.S_ComboBox S_Reclami;
		protected S_Controls.S_ComboBox S_chiar_inf;
		...
		private void BindCdC( int id_servizio )
		{
			...
			DataSet _MyDs;
			_MyDs=_Contab.GetSingleDataSV_Rev_(id_servizio);
			if (_MyDs.Tables[0].Rows.Count > 0)
			{
		...
		private S_ControlsCollection GetData()
		{
			...
			S_Controls.Collections.S_Object s_p_DataSopralluogo_da = new S_Object();
			s_p_DataSopralluogo_da.ParameterName = "p_datasopralluogo_da";
			s_p_DataSopralluogo_da.DbType = CustomDBType.VarChar;
			s_p_DataSopralluogo_da.Direction = ParameterDirection.Input;
			s_p_DataSopralluogo_da.Index = _SCollection.Count;			
			s_p_DataSopralluogo_da.Size=30;
			s_p_DataSopralluogo_da.Value = (CalendarPicker4.Datazione.Text =="")? "":CalendarPicker4.Datazione.Text;
			_SCollection.Add(s_p_DataSopralluogo_da);

			// DATASOPRALLUOGO a
			S_Controls.Collections.S_Object s_p_DataSopralluogo_a = new S_Object();
			s_p_DataSopralluogo_a.ParameterName = "p_datasopralluogo_a";
			s_p_DataSopralluogo_a.DbType = CustomDBType.VarChar;
			s_p_DataSopralluogo_a.Direction = ParameterDirection.Input;
			s_p_DataSopralluogo_a.Index = _SCollection.Count;			
			s_p_DataSopralluogo_a.Size=30;
			s_p_DataSopralluogo_a.Value = (Calendarpicker40.Datazione.Text =="")? "":Calendarpicker40.Datazione.Text;
			_SCollection.Add(s_p_DataSopralluogo_a);
			...
			p_progetto.DbType =CustomDBType.VarChar;
			...
			p_idcontabilizzazione.Index = _SCollection.Count;
			...
			p_idApprovazione.Index = _SCollection.Count;
			...
			S_Controls.Collections.S_Object p_sollecito = new S_Controls.Collections.S_Object();
			p_sollecito.ParameterName = "p_sollecito";
			p_sollecito.DbType =CustomDBType.VarChar;
			p_sollecito.Direction = ParameterDirection.Input;
			p_sollecito.Index = _SCollection.Count;
			p_sollecito.Size= 100;
			p_sollecito.Value=S_Solleciti.SelectedValue;
			_SCollection.Add(p_sollecito);

			S_Controls.Collections.S_Object p_reclamo = new S_Controls.Collections.S_Object();
			p_reclamo.ParameterName = "p_reclamo";
			p_reclamo.DbType =CustomDBType.VarChar;
			p_reclamo.Direction = ParameterDirection.Input;
			p_reclamo.Index = _SCollection.Count;
			p_reclamo.Size= 100;
			p_reclamo.Value=S_Reclami.SelectedValue;
			_SCollection.Add(p_reclamo);

			S_Controls.Collections.S_Object p_chiar_inf = new S_Controls.Collections.S_Object();
			p_chiar_inf.ParameterName = "p_chiar_inf";
			p_chiar_inf.DbType =CustomDBType.VarChar;
			p_chiar_inf.Direction = ParameterDirection.Input;
			p_chiar_inf.Index = _SCollection.Count;
			p_chiar_inf.Size= 100;
			p_chiar_inf.Value=S_chiar_inf.SelectedValue;
			_SCollection.Add(p_chiar_inf);
		...
		private void DataGridRicerca_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{ 
				...
				if(e.Item.Cells[20].Text.Trim()=="4" || e.Item.Cells[20].Text.Trim()=="3")//  se è stato approvato
				{
					_imgOK.Visible=true;
				...
				else
				{
					...
					{         
						...
						case "3":  // livello   cte il terzo che Autorizza            
							...
							break;
						case "4":      // livello   ULTIMO è STATO TUTTO AUTORIZZATO il terzo che Autorizza        							 
							_imgVerde.Visible=false;
							_imgVerde.ToolTip = "La RDL è stata Approvata Definitivamente";
							_imgRossa.Visible=false;
							_imgRossa.ToolTip =  "La RDL è stata Approvata Definitivamente";
							_imgLuc.Visible=true;
							_imgLuc.Attributes.Add("title",tooltip_imgLuc);
							break;
						default: 
...
//				}							
		...
		private void RicercaManRichiesta(bool reset)
		{
			...
			if (reset==true)
			{
				...
				int _totalRecords = _Richiesta.GetCount1_rev(_SCollection);
			...
			DataSet _MyDs = _Richiesta.GetSfogliaRDL1_rev(_SCollection).Copy();		
