					...
					<TR>
						<TD height="95%" vAlign="top" align="center">
							<TABLE id="tblForm" cellSpacing="1" cellPadding="1" align="center">
								<TBODY>
									<TR>
										<TD style="HEIGHT: 25%" vAlign="top" align="left"><COLLAPSE:DATAPANEL style="Z-INDEX: 0" id="PanelRicerca" runat="server" Height="361" TitleStyle-CssClass="TitleSearch"
												...
												<TABLE id="tblSearch100" border="0" cellSpacing="1" cellPadding="2">
													<TBODY>
														...
														<tr>
															<TD align="left">Data Sopralluogo Da:</TD>
															<TD><uc1:calendarpicker id="CalendarPicker4" runat="server"></uc1:calendarpicker></TD>
															<TD align="left">Data Sopralluogo A:</TD>
															<TD><uc1:calendarpicker id="Calendarpicker40" runat="server"></uc1:calendarpicker></TD>
														</tr>
														<TR>
														...
														<TR>
															...
															<TD style="HEIGHT: 22px"><cc1:s_combobox style="Z-INDEX: 0" id="S_combAutorizzazione" runat="server" Width="99%">
									...
									<tr>
										<TD style="HEIGHT: 22px" align="left">Solleciti:</TD>
										<TD style="HEIGHT: 22px"><cc1:s_combobox style="Z-INDEX: 0" id="S_Solleciti" runat="server" Width="99%">
												<asp:ListItem Value="0">Tutte</asp:ListItem>
												<asp:ListItem Value="1">RdL con solleciti</asp:ListItem>
												<asp:ListItem Value="2">RdL senza solleciti</asp:ListItem>
											</cc1:s_combobox></TD>
										<TD style="HEIGHT: 22px" align="left">Reclami:</TD>
										<TD style="HEIGHT: 22px"><cc1:s_combobox style="Z-INDEX: 0" id="S_Reclami" runat="server" Width="99%">
												<asp:ListItem Value="0">Tutte</asp:ListItem>
												<asp:ListItem Value="1">RdL con reclami</asp:ListItem>
												<asp:ListItem Value="2">RdL senza reclami</asp:ListItem>
											</cc1:s_combobox></TD>
									</tr>
									<tr>
										<TD style="HEIGHT: 22px" align="left">Chiarimenti-Informazioni:</TD>
										<TD style="HEIGHT: 22px"><cc1:s_combobox style="Z-INDEX: 0" id="S_chiar_inf" runat="server" Width="99%">
												<asp:ListItem Value="0">Tutte</asp:ListItem>
												<asp:ListItem Value="1">RdL chiarimenti-informazioni</asp:ListItem>
												<asp:ListItem Value="2">RdL senza chiarimenti-informazioni</asp:ListItem>
											</cc1:s_combobox></TD>
										<td colspan="2"></td>
									</tr>
									<TR>
                  ...
                  >Guida</A></TD>
					...
					<TR id="trstraordinaria">
						<TD vAlign="top" width="100%" align="center"><uc1:gridtitle id="GridTitle1" runat="server"></uc1:gridtitle><asp:datagrid style="Z-INDEX: 0" id="DataGridRicerca" runat="server" CssClass="DataGrid" Width="100%"
								ShowFooter="True" AllowPaging="True" BorderColor="Gray" AllowCustomPaging="True" BorderWidth="1px" GridLines="Vertical" AutoGenerateColumns="False">
					...
					<TR id="trrichiesta">
						<TD vAlign="top" width="100%" align="center"><INPUT id="HidSato" type="hidden" name="Hidden1" runat="server"><uc1:gridtitle id="Gridtitle2" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca2" runat="server" CssClass="DataGrid" AllowPaging="True" BorderColor="Gray"
								...
								<Columns>
									...
									<asp:TemplateColumn>
										...
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
										<ItemTemplate>
											<asp:ImageButton id=Imagebutton1 Runat="server" CommandName="Dettaglio" CommandArgument='<%# "CompletaRdl1.aspx?wr_id=" + DataBinder.Eval(Container.DataItem,"WR_ID") %>' ImageUrl="../images/edit.gif" >
											</asp:ImageButton>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn Visible="False">
