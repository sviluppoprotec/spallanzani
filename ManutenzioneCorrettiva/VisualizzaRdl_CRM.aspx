<%@ Page language="c#" Codebehind="VisualizzaRdl_CRM.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneCorretiva.VisualizzaRdl_CRM" %>
							...
							<TR>
								<TD colSpan="2">
									<TABLE id="tblSearch100" border="0" cellSpacing="1" cellPadding="1">
										...
										<TR>
										<tr>
											<TD class="Title" colSpan="3">Numero CRM:</TD>
											<td colSpan="5"><asp:label id="Lblnr_crm" runat="server"></asp:label></td>
										</tr>
									</TABLE>
								</TD>
							</TR>
								...
								<td colSpan="2">
									<DIV style="BORDER-BOTTOM: black 1px solid; BORDER-LEFT: black 1px solid; BORDER-TOP: black 1px solid; BORDER-RIGHT: black 1px solid">
										<TABLE border="0" cellSpacing="1" cellPadding="1" width="100%">
											...
											<TR>
												<TD style="HEIGHT: 14px" width="25%">TIPO MANUTENZIONE:</TD>
												<TD style="HEIGHT: 14px" colSpan="3"><asp:label id="Lbltipomanut" runat="server"></asp:label>
												<TD></TD>
											<tr>
												<TD style="HEIGHT: 14px" width="25%">PROGRAMMABILITA' INTERVENTO:</TD>
												<TD style="HEIGHT: 14px" colSpan="3"><asp:label id="lblTipoIntervento" runat="server"></asp:label>
													<INPUT style="WIDTH: 8px; HEIGHT: 18px" id="HidTipInter" size="1" type="hidden" name="HidTipInter"
														runat="server"></TD>
											</tr>
											<TR>
								...
								<TD style="HEIGHT: 1%" vAlign="top" width="10%" colSpan="2" align="left">
									<TABLE id="Table1" border="0" cellSpacing="1" cellPadding="1" width="100%">
										<TR>
											...
											<TD><asp:button id="BtSalvaSGA" runat="server" Text="Salva/Invia Email" Width="120px"></asp:button></TD>
