...
namespace TheSite.ManutenzioneCorrettiva
{
	...
	/// </summary>
	public class CreazioneSGA_CRM : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.DropDownList CmbASeguito;
		protected System.Web.UI.WebControls.TextBox TxtASeguito1;
		protected System.Web.UI.WebControls.TextBox TxtASeguito4;
		...
		protected System.Web.UI.WebControls.TextBox TxtSopralluogo;
		protected System.Web.UI.WebControls.DataGrid DataGridRicerca;
		protected System.Web.UI.WebControls.DataGrid DatagridEmesse;
		protected WebControls.CalendarPicker CPConduzioneData;
		protected WebControls.CalendarPicker CPAseguito;
		protected WebControls.CalendarPicker CalendarPiker4;
		protected WebControls.CalendarPicker CalendarPiker3;
		protected WebControls.CalendarPicker CPSopralluogoDie;
		protected WebControls.CalendarPicker CPSopralluogoData;
		public string url="";
		protected System.Web.UI.WebControls.Panel Conduzione;
		protected System.Web.UI.WebControls.Panel Sopralluogo;
		protected System.Web.UI.WebControls.DropDownList MinutiConduzione;
		protected System.Web.UI.WebControls.DropDownList OraConduzione;
		...
		protected System.Web.UI.WebControls.TextBox txt_CRM;
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			string _mypage="./ManutenzioneCorrettiva/CreazioneSGA_CRM.aspx";			
			...
			txt_CRM.Attributes.Add("onkeypress","SoloNumeri();");
			...
			ChkConduzione.Attributes.Add("onclick","bloccachk ('"+ ChkConduzione.ClientID +"' );");
			ChkSopralluogo.Attributes.Add("onclick","bloccachk ('"+ ChkSopralluogo.ClientID +"' );");
			string chk = "";
			chk =  "<script language=\"javascript\">\n";
			chk += "bloccachk('" + ChkConduzione.ClientID + "');\n";
			chk += "bloccachk('" + ChkSopralluogo.ClientID + "');\n";
			chk += "</script>\n";
			if(!this.IsStartupScriptRegistered("clientScript1"))
				this.RegisterStartupScript("clientScript1", chk);
		...
		{    
			...
			this.Cv1.ServerValidate += new System.Web.UI.WebControls.ServerValidateEventHandler(this.Cv1_ServerValidate);
		...
		private void LoadASeguito()
		{
			...
			if (_MyDs.Tables[0].Rows.Count > 0)
			{
				...
				this.CmbASeguito.DataSource = Classi.GestoreDropDownList.ItemBlankDataSource(
					_MyDs.Tables[0], "descrizione", "id", "- Selezionare un valore -", "");				
		...
		private void BindControls(string Codice)
		{
			...
			if(Codice!="")
			{
				...
				cmbsUrgenza.Items.RemoveAt(3);
				cmbsUrgenza.Items.RemoveAt(3);
				cmbsUrgenza.Items.RemoveAt(3);
				
//				<option value="48">Programmabile a Breve (5 gg)</option>
//	<option value="39">Programmabile a Medio (10 gg)</option>
//	<option value="4">Programmabile a Lungo (15 gg)</option>
...
//					this.cmbsServizio.DataBind();
			...
			if (_Richiesta.IsValidBlId(this.RicercaModulo1.BlId))
			{
				...
				{	
					...
					if (ItemId== 0)
					{
						...
						Response.Redirect("VisualizzaRdl_CRM.aspx?FunId=" + FunId + "&ItemId=" + i_Wr_Id.ToString()+ VarApp);
					}
					else
					{
		...
		private int NuovaRichiesta()
		{
			...
			S_Controls.Collections.S_Object s_P_CONDUZIONE = new S_Controls.Collections.S_Object();
			s_P_CONDUZIONE.ParameterName = "P_CONDUZIONE";
			s_P_CONDUZIONE.DbType = CustomDBType.Integer;
			s_P_CONDUZIONE.Direction = ParameterDirection.Input;
			s_P_CONDUZIONE.Index = _SColl.Count;
			s_P_CONDUZIONE.Value =(ChkConduzione.Checked==true)?1:0;
			_SColl.Add(s_P_CONDUZIONE);

			S_Controls.Collections.S_Object s_P_DATA_CONDUZIONE = new S_Controls.Collections.S_Object();
			s_P_DATA_CONDUZIONE.ParameterName = "P_DATA_CONDUZIONE";
			s_P_DATA_CONDUZIONE.DbType = CustomDBType.VarChar;
			s_P_DATA_CONDUZIONE.Direction = ParameterDirection.Input;
			s_P_DATA_CONDUZIONE.Index = _SColl.Count;
			s_P_DATA_CONDUZIONE.Size=10;
			s_P_DATA_CONDUZIONE.Value = CPConduzioneData.Datazione.Text;
			_SColl.Add(s_P_DATA_CONDUZIONE);

			S_Controls.Collections.S_Object s_P_ORA_CONDUZIONE = new S_Controls.Collections.S_Object();
			s_P_ORA_CONDUZIONE.ParameterName = "P_ORA_CONDUZIONE";
			s_P_ORA_CONDUZIONE.DbType = CustomDBType.VarChar;
			s_P_ORA_CONDUZIONE.Direction = ParameterDirection.Input;
			s_P_ORA_CONDUZIONE.Index = _SColl.Count;
			s_P_ORA_CONDUZIONE.Size=5;
			s_P_ORA_CONDUZIONE.Value = OraConduzione.SelectedValue + ":" + MinutiConduzione.SelectedValue;
			_SColl.Add(s_P_ORA_CONDUZIONE);

			if (CmbASeguito.SelectedValue!="")
			{
				S_Controls.Collections.S_Object s_P_ID_SGA_SEGUITO = new S_Controls.Collections.S_Object();
				s_P_ID_SGA_SEGUITO.ParameterName = "P_ID_SGA_SEGUITO";
				s_P_ID_SGA_SEGUITO.DbType=CustomDBType.Integer;
				s_P_ID_SGA_SEGUITO.Direction = ParameterDirection.Input;
				s_P_ID_SGA_SEGUITO.Index = _SColl.Count;
				s_P_ID_SGA_SEGUITO.Value = CmbASeguito.SelectedValue;
				_SColl.Add(s_P_ID_SGA_SEGUITO);
			}
		
			S_Controls.Collections.S_Object s_P_DIE_NUMERO = new S_Controls.Collections.S_Object();
			s_P_DIE_NUMERO.ParameterName = "P_DIE_NUMERO";
			s_P_DIE_NUMERO.DbType = CustomDBType.VarChar;
			s_P_DIE_NUMERO.Direction = ParameterDirection.Input;
			s_P_DIE_NUMERO.Index = _SColl.Count;
			s_P_DIE_NUMERO.Size=5;
			s_P_DIE_NUMERO.Value = TxtASeguito1.Text;
			_SColl.Add(s_P_DIE_NUMERO);

			S_Controls.Collections.S_Object s_P_DIE_DEL = new S_Controls.Collections.S_Object();
			s_P_DIE_DEL.ParameterName = "P_DIE_DEL";
			s_P_DIE_DEL.DbType = CustomDBType.VarChar;
			s_P_DIE_DEL.Direction = ParameterDirection.Input;
			s_P_DIE_DEL.Index = _SColl.Count;
			s_P_DIE_DEL.Size=10;
			s_P_DIE_DEL.Value = CPAseguito.Datazione.Text;
			_SColl.Add(s_P_DIE_DEL);

			S_Controls.Collections.S_Object s_P_SOPRALLUOGO = new S_Controls.Collections.S_Object();
			s_P_SOPRALLUOGO.ParameterName = "P_SOPRALLUOGO";
			s_P_SOPRALLUOGO.DbType = CustomDBType.Integer;
			s_P_SOPRALLUOGO.Direction = ParameterDirection.Input;
			s_P_SOPRALLUOGO.Index = _SColl.Count;
			s_P_SOPRALLUOGO.Value = (ChkSopralluogo.Checked==true)?1:0;
			_SColl.Add(s_P_SOPRALLUOGO);

			S_Controls.Collections.S_Object s_P_SOPRALLUOGO_N = new S_Controls.Collections.S_Object();
			s_P_SOPRALLUOGO_N.ParameterName = "P_SOPRALLUOGO_N";
			s_P_SOPRALLUOGO_N.DbType = CustomDBType.VarChar;
			s_P_SOPRALLUOGO_N.Direction = ParameterDirection.Input;
			s_P_SOPRALLUOGO_N.Index = _SColl.Count;
			s_P_SOPRALLUOGO_N.Size=9;
			s_P_SOPRALLUOGO_N.Value = TxtSopralluogo.Text;
			_SColl.Add(s_P_SOPRALLUOGO_N);

			S_Controls.Collections.S_Object s_P_SOPRALLUOGO_DEL = new S_Controls.Collections.S_Object();
			s_P_SOPRALLUOGO_DEL.ParameterName = "P_SOPRALLUOGO_DEL";
			s_P_SOPRALLUOGO_DEL.DbType = CustomDBType.VarChar;
			s_P_SOPRALLUOGO_DEL.Direction = ParameterDirection.Input;
			s_P_SOPRALLUOGO_DEL.Index = _SColl.Count;
			s_P_SOPRALLUOGO_DEL.Size=10;
			s_P_SOPRALLUOGO_DEL.Value = CPSopralluogoDie.Datazione.Text;
			_SColl.Add(s_P_SOPRALLUOGO_DEL);

			S_Controls.Collections.S_Object s_P_SOPRALLUOGO_DATA = new S_Controls.Collections.S_Object();
			s_P_SOPRALLUOGO_DATA.ParameterName = "P_SOPRALLUOGO_DATA";
			s_P_SOPRALLUOGO_DATA.DbType = CustomDBType.VarChar;
			s_P_SOPRALLUOGO_DATA.Direction = ParameterDirection.Input;
			s_P_SOPRALLUOGO_DATA.Index = _SColl.Count;
			s_P_SOPRALLUOGO_DATA.Size=10;
			s_P_SOPRALLUOGO_DATA.Value = CPSopralluogoData.Datazione.Text;
			_SColl.Add(s_P_SOPRALLUOGO_DATA);

			S_Controls.Collections.S_Object s_P_SOPRALLUOGO_DA = new S_Controls.Collections.S_Object();
			s_P_SOPRALLUOGO_DA.ParameterName = "P_SOPRALLUOGO_DA";
			s_P_SOPRALLUOGO_DA.DbType = CustomDBType.VarChar;
			s_P_SOPRALLUOGO_DA.Direction = ParameterDirection.Input;
			s_P_SOPRALLUOGO_DA.Index = _SColl.Count;
			s_P_SOPRALLUOGO_DA.Size=70;
			s_P_SOPRALLUOGO_DA.Value = TxtASeguito4.Text;
			_SColl.Add(s_P_SOPRALLUOGO_DA);
			...
			S_Controls.Collections.S_Object s_p_CRM = new S_Controls.Collections.S_Object();
			s_p_CRM.ParameterName = "p_CRM";
			s_p_CRM.DbType = CustomDBType.VarChar;
			s_p_CRM.Direction = ParameterDirection.Input;
			s_p_CRM.Index = _SColl.Count;
			s_p_CRM.Value =txt_CRM.Text;  
			_SColl.Add(s_p_CRM);
			...
			{
				if (ItemId != 0)
					i_WrId = _Richiesta.ModificaRDL_DEMO(_SColl,ItemId);
				else
					i_WrId = _Richiesta.Crea_DEMO(_SColl);
			}
			catch (Exception ex)
			{
		...
		{
			Response.Redirect("CreazioneSGA_CRM.aspx?FunId=" + ViewState["FunId"]);
		...
		private void LoadDatiCreazione(int ItemId)
		{
			...
			{	
				...
				//				Aseguito += "</script>\n";
				//	
				//				if(!this.IsStartupScriptRegistered("clientScriptReper2"))
				//					this.RegisterStartupScript("clientScriptReper2", Aseguito);
				...
				if (_Dr["data_conduzione"] != DBNull.Value)
					CPConduzioneData.Datazione.Text=_Dr["data_conduzione"].ToString();

				if (_Dr["ora_conduzione"] != DBNull.Value)
				{
					OraConduzione.SelectedValue=_Dr["ora_conduzione"].ToString().Split(':')[0];
					MinutiConduzione.SelectedValue=_Dr["ora_conduzione"].ToString().Split(':')[1];
				}

				if (_Dr["id_sga_seguito"] != DBNull.Value)
					CmbASeguito.SelectedValue=_Dr["id_sga_seguito"].ToString();

				if (_Dr["die_numero"] != DBNull.Value)
					TxtASeguito1.Text=_Dr["die_numero"].ToString();

				if (_Dr["die_del"] != DBNull.Value)
					CPAseguito.Datazione.Text=_Dr["die_del"].ToString();
				...
				if (_Dr["sopralluogo_del"] != DBNull.Value)
					CPSopralluogoDie.Datazione.Text=_Dr["sopralluogo_del"].ToString();

				if (_Dr["sopralluogo_data"] != DBNull.Value)
					CPSopralluogoData.Datazione.Text=_Dr["sopralluogo_data"].ToString();
				...
				if (_Dr["nr_crm"].ToString().Trim()!="")
				{
					txt_CRM.Text=_Dr["nr_crm"].ToString();
				}
				else
			...
			private void Cv1_ServerValidate(object source, System.Web.UI.WebControls.ServerValidateEventArgs args)
			{
				...
				if(idp=="1")
				{
					...
					if(dif=="61")
					{
						if (ur=="1" && ur=="2" && ur=="3")
						{
							((CustomValidator)source).ErrorMessage ="L'intervento DIFFERIBILE NON deve avere una urgenza CRITICA, URGENTE O EMERGENZA!";
							args.IsValid = false;
						}
					}
					else
					{
						if (ur!="1" && ur!="2" && ur!="3")
						{
							...
							((CustomValidator)source).ErrorMessage ="L'intervento NON DIFFERIBILE deve avere una urgenza CRITICA, URGENTE O EMERGENZA!";
							args.IsValid = false;
						}
