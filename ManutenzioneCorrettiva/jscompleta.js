...
function RicalcolaTotaliAG() {
	...
	// manuale #
	var txtCMat1 = document.getElementById('txtCostiMateriali1') && document.getElementById('txtCostiMateriali1').value || '';
	var txtCMat2 = document.getElementById('txtCostiMateriali2') && document.getElementById('txtCostiMateriali2').value || '';
	var txtCPer1 = document.getElementById('txtCostiPersonale1') && document.getElementById('txtCostiPersonale1').value || '';
	var txtCPer2 = document.getElementById('txtCostiPersonale2') && document.getElementById('txtCostiPersonale2').value || '';
