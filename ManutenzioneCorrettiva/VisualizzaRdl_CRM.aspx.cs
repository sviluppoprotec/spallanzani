...
namespace TheSite.ManutenzioneCorretiva
{
	...
	/// </summary>
	public class VisualizzaRdl_CRM : System.Web.UI.Page
	{
		...
		protected System.Web.UI.WebControls.Label Lblnr_crm;
		protected System.Web.UI.WebControls.Label Lbltipomanut;
		int id_bl=0;
...
//						this.lblAseguito4.Text = "DA  "+_Dr["sga_aseguito4"].ToString();
		...
		{
			Response.Redirect("CompletaRdl_CRM.aspx?wr_id=" + txtWrHidden.Text);	
		}
		...
		private void btnModificaRDL_Click(object sender, System.EventArgs e)
		{
			...
			Response.Redirect("CreazioneSGA_CRM.aspx?ItemId=" + txtWrHidden.Text + VarApp);			
		}
...
//				mailMessage.Cc="sgadie@cofasir.it";
