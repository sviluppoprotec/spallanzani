<%@ Page language="c#" Codebehind="SfogliaRdlPaging7.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneCorrettiva.SfogliaRdlPaging7" %>
						...
						<TD vAlign="top" width="100%" align="center"><uc1:gridtitle id="GridTitle1" runat="server"></uc1:gridtitle><asp:datagrid style="Z-INDEX: 0" id="DataGridRicerca" runat="server" CssClass="DataGrid" Width="100%"
								...
								<Columns>
									...
									<asp:TemplateColumn>
										...
										<ItemTemplate>
											<asp:ImageButton id="lnkDett" Runat="server" CommandName="Dettaglio" CommandArgument='<%# "CompletaRdl_CRM.aspx?wr_id=" + DataBinder.Eval(Container.DataItem,"WR_ID") %>' ImageUrl="../images/edit.gif">
											</asp:ImageButton>
										</ItemTemplate>
									</asp:TemplateColumn>
						...
						<TD vAlign="top" width="100%" align="center"><INPUT id="HidSato" type="hidden" name="Hidden1" runat="server"><uc1:gridtitle id="Gridtitle2" runat="server"></uc1:gridtitle><asp:datagrid id="DataGridRicerca2" runat="server" CssClass="DataGrid" AllowPaging="True" BorderColor="Gray"
								...
								<Columns>
									...
									<asp:TemplateColumn>
										...
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
										<ItemTemplate>
											<asp:ImageButton id=Imagebutton1 Runat="server" CommandName="Dettaglio" CommandArgument='<%# "CompletaRdl_CRM.aspx?wr_id=" + DataBinder.Eval(Container.DataItem,"WR_ID") %>' ImageUrl="../images/edit.gif" >
											</asp:ImageButton>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:TemplateColumn Visible="False">
										...
										<ItemStyle HorizontalAlign="Center" VerticalAlign="Middle"></ItemStyle>
										<ItemTemplate>
											<asp:ImageButton id="Imagebutton3" Runat="server" CommandName="Modifica" ImageUrl="../images/Search16x16_bianca.JPG" CommandArgument='<%# "CreazioneSGA_CRM.aspx?ItemId=" + DataBinder.Eval(Container.DataItem,"WR_ID")%>'>
											</asp:ImageButton>
										</ItemTemplate>
									</asp:TemplateColumn>
									<asp:BoundColumn DataField="EDIF" HeaderText="EDIF."></asp:BoundColumn>
