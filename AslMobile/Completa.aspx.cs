...
namespace TheSite.AslMobile
{
	...
	public class Completa : System.Web.UI.MobileControls.MobilePage
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.p_lblRDL = ((System.Web.UI.MobileControls.Label)Panel4.Controls[0].FindControl("lblRDL"));
			this.p_lblData = ((System.Web.UI.MobileControls.Label)Panel4.Controls[0].FindControl("lblData"));
			this.p_lblOra = ((System.Web.UI.MobileControls.Label)Panel4.Controls[0].FindControl("lblOra"));
			
			this.p_lblRDL.Text= Request.QueryString["ItemID"].ToString();			
			this.p_lblData.Text="01/01/1900";
			this.p_lblOra.Text="00.00";
			...
			if(!IsPostBack)
			{
				...
				SetValue(Panel4,"txtOraStart","00");//txtOraStart//txtMinutiStart//txtOraEnd
				SetValue(Panel4,"txtMinutiStart","00");//txtOraStart//txtMinutiStart//txtOraEnd
				SetValue(Panel4,"txtOraEnd","00");//txtOraStart//txtMinutiStart//txtOraEnd
				SetValue(Panel4,"txtMinutiEnd","00");//txtOraStart//txtMinutiStart//txtOraEnd
...
//				}
				...
				if(capitolato!="")
				{
					string[] dtp=GetValue(Panel4,"lblData").Split(Convert.ToChar("/"));
					string[] orap=GetValue(Panel4,"lblOra").Split(Convert.ToChar("."));
					...
					{
						string[] dtpia=GetValue(Panel4,"lblDataStart").Split(Convert.ToChar("/"));
						string OraP=GetValue(Panel4,"txtOraStart")+":"+GetValue(Panel4,"txtMinutiStart");
						string[] orapia;
                        if(OraP.IndexOf(".")>0)
