					...
					<ContentTemplate>
						<TABLE id="Table2" style="BORDER-RIGHT: darkgray 1px solid; BORDER-TOP: darkgray 1px solid; FONT-SIZE: 11px; BORDER-LEFT: #666666 1px solid; WIDTH: 100%; COLOR: #000077; BORDER-BOTTOM: darkgray 1px solid; FONT-FAMILY: Verdana, Arial; BACKGROUND-COLOR: whitesmoke"
							...
							<TR>
								...
								<TD>
									<mobile:Link id="lkRichiesta" runat="server" Font-Size="Large" NavigateUrl="Richiesta.aspx">Creazione RdL</mobile:Link></TD>
							</TR>
							<TR>
								<TD>
									<mobile:Image id="Image3" runat="server" ImageUrl="images/Nota2.gif"></mobile:Image></TD>
								<TD>
									<mobile:Link id="Link2" runat="server" Font-Size="Large" NavigateUrl="Rcompleta.aspx">Completamento RdL</mobile:Link></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD>
									<mobile:Link id="Link1" runat="server" Font-Size="Large" NavigateUrl="CompletamentoMP.aspx">Completamento OdL</mobile:Link></TD>
							</TR>
							<TR>
