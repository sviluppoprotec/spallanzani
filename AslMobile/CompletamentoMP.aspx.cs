...
namespace TheSite.AslMobile
{
	...
	public class CompletamentoMP : System.Web.UI.MobileControls.MobilePage
	{
		...
		protected void OnRicerca(object sender, System.EventArgs e)
		{
			...
			// Data Da						
			int giornoDA = 1;
			int meseDA = Int32.Parse(this.GetValue(pnlRicerca.Controls[0],"cmbsMeseDa"));
			int annoDA = Int32.Parse(this.GetValue(pnlRicerca.Controls[0],"cmbsAnnoDa"));			
			this.dataDA = giornoDA + "/" + meseDA + "/" + annoDA;

			int giornoA = DateTime.DaysInMonth(Int32.Parse(this.GetValue(pnlRicerca.Controls[0],"cmbsAnnoA")),Int32.Parse(this.GetValue(pnlRicerca.Controls[0],"cmbsMeseA")));			
			int meseA = Int32.Parse(this.GetValue(pnlRicerca.Controls[0],"cmbsMeseA"));			
			int annoA = Int32.Parse(this.GetValue(pnlRicerca.Controls[0],"cmbsAnnoA"));	
