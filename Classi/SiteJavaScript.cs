...
//		}
		...
		public static void ShowFrameReclamo(Page CurrentPage, int NumDirectory)
		{
			string dir="";	
			for (int i = 0; i < NumDirectory; i++)
			{
			...
			System.Text.StringBuilder _StrBld = new System.Text.StringBuilder();
			_StrBld.Append(s_TestataScript);
			_StrBld.Append("function ShowFrameAddReclamo(sender,idquery,e){\n");
			_StrBld.Append("var ctrl = document.getElementById(\"PopupAddReclamo\").style;\n");
			_StrBld.Append("x = e.clientX;\n");
			_StrBld.Append("y = e.clientY;\n");
			_StrBld.Append("ctrl.left = 10;\n");
			_StrBld.Append("ctrl.top = y+30;\n");  
			...
			_StrBld.Append("if (ctrl.display =='none') ctrl.display='block';\n");
			_StrBld.Append("ctrl2= document.getElementById(sender).value;\n");
			_StrBld.Append("document.getElementById(\"addReclamo\").src=\"" + dir + "CommonPage/Reclamo.aspx?\" + idquery + \"=\" + ctrl2;\n");// + \"&idmodulo=\" + idmodulo + \"&ms=\" + ms;\n");  			
			_StrBld.Append("}\n");
			_StrBld.Append(s_CodaScript);
			RegisterStartUpScritp(CurrentPage,"Reclamo", _StrBld.ToString());
		}
		
		public static void ShowFrameChiariInfo(Page CurrentPage, int NumDirectory)
		{
			string dir="";	
			for (int i = 0; i < NumDirectory; i++)
			{
			...
			System.Text.StringBuilder _StrBld = new System.Text.StringBuilder();
			_StrBld.Append(s_TestataScript);
			_StrBld.Append("function ShowFrameAddChiariInfo(sender,idquery,e){\n");
			_StrBld.Append("var ctrl = document.getElementById(\"PopupAddChiariInfo\").style;\n");
			_StrBld.Append("x = e.clientX;\n");
			_StrBld.Append("y = e.clientY;\n");
			_StrBld.Append("ctrl.left = 10;\n");
			_StrBld.Append("ctrl.top = y+30;\n");  
			...
			_StrBld.Append("if (ctrl.display =='none') ctrl.display='block';\n");
			_StrBld.Append("ctrl2= document.getElementById(sender).value;\n");
			_StrBld.Append("document.getElementById(\"addChiariInfo\").src=\"" + dir + "CommonPage/ChiariInfo.aspx?\" + idquery + \"=\" + ctrl2;\n");
			_StrBld.Append("}\n");
			_StrBld.Append(s_CodaScript);
			RegisterStartUpScritp(CurrentPage,"ChiariInfo", _StrBld.ToString());
		}
...
//		}
		...
		public static void ShowFramePMPCP(Page CurrentPage, int NumDirectory)
		{
			string dir="";	
			for (int i = 0; i < NumDirectory; i++)
			{
			...
			System.Text.StringBuilder _StrBld = new System.Text.StringBuilder();
			_StrBld.Append(s_TestataScript);
			_StrBld.Append("function ShowFramePMPCP(sender,idquery,e,idmodulo){\n");
			_StrBld.Append("var ctrl = document.getElementById(\"Popupmatricole\").style;\n");
			_StrBld.Append("x = e.clientX;\n");
			_StrBld.Append("y = e.clientY;\n");
			_StrBld.Append("ctrl.left = 50;\n");
			...
			_StrBld.Append("if (ctrl.display =='none') ctrl.display='block';\n");
			_StrBld.Append("ctrl2= document.getElementById(sender).value;\n");
			_StrBld.Append("document.getElementById(\"docmatricole\").src=\"" + dir + "CommonPage/ListaPMPCP.aspx?\" + idquery + \"=\" + ctrl2 + \"&idmodulo=\" + idmodulo;\n");
			_StrBld.Append("}\n");
			_StrBld.Append(s_CodaScript);
			RegisterStartUpScritp(CurrentPage,"matricole", _StrBld.ToString());
		}
