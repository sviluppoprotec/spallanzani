...
namespace TheSite.Classi.CostiOperativi
{
	...
	public class Richiesta : AbstractBase
	{
		...
		public  DataSet GetSfogliaRDL_r1(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;	
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_COSTIOPERATIVIGESTIONE.SP_GetSfogliaRDL_r1";
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  DataSet GetSfogliaRDLCount_r1(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;	
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_COSTIOPERATIVIGESTIONE.SP_GetSfogliaRDLCount_r1";
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		//A richiesta//
		public  DataSet GetSfogliaRDL_r2(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;	
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_COSTIOPERATIVIGESTIONE.SP_GetSfogliaRDLPaging";
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  int GetSfogliaRDLCount_r2(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;	
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_COSTIOPERATIVIGESTIONE.SP_GetSfogliaRDLCount";
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
