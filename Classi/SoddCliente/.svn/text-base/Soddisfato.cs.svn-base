...
{
	/// <summary>
	/// Descrizione di riepilogo per Soddisfato.
	/// </summary>
	public class Soddisfato : AbstractBase
	{
		...
		//public Soddisfato(int Id) : this(Id, string.Empty) {}

//		public Soddisfato(int Id, string Priorita) 
//		{
//			this.Id = Id;
...
//		}
		...
		public DataSet GetKPI(S_ControlsCollection CollezioneControlli)
	{
		...
		ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
		string s_StrSql = "PACK_KPI.ContaWR";	
		_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		return _Ds;		
	}
		public DataSet GetPianiMensili(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_KPI.ContaPianiMensili";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
			return _Ds;		
		}
		public DataSet GetXls(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_KPI.GET_TRACCIA_COD";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
			return _Ds;		
		}
		public DataSet GetREI(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_KPI.ContaPorteRei";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
			return _Ds;		
		}
		...
		public DataSet numAttivita(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_KPI.ContaAttPPUno";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
			return _Ds;		
		}
