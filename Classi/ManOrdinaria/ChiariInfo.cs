...
namespace TheSite.Classi.ManOrdinaria
{
	...
	/// </summary>
	public class ChiariInfo : AbstractBase
	{
		public ChiariInfo()
		{
		...
		public DataSet GetDataWR(string WR_id)
		{
			...
			string s_StrSql = "PACK_SOLLECITO.SP_GETALLchiarim_inform_WR";
		...
		public DataSet SP_GEINFOWR(string WR_id)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_SOLLECITO.SP_GEINFOWR";
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
