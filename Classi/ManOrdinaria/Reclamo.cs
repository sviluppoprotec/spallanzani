...
namespace TheSite.Classi.ManOrdinaria
{
	...
	/// </summary>
	public class Reclamo : AbstractBase
	{
		public Reclamo()
		{
		...
		public DataSet GetDataWR(string WR_id)
		{
			...
			string s_StrSql = "PACK_SOLLECITO.SP_GETALLRECLAMI_WR";
		...
		public int ExecuteAddReclamo(S_ControlsCollection CollezioneControlli, int itemId)
		{			
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_SOLLECITO.SP_ADDRECLAMO");
