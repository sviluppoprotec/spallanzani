...
namespace TheSite.Classi.AnagrafeImpianti
{
	...
	public class AnagrafeDocDWF: AbstractBase
	{
		...
		public  DataSet GetCodeAllBuildings()
		{
			S_ControlsCollection CollezioneControlli=new S_ControlsCollection();
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_DWF.SP_GETCODEALLBUILDINGS";	
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		public  int CONTOREPORTKPI(string mese, string anno)
		{
			S_ControlsCollection CollezioneControlli=new S_ControlsCollection();
			...
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_KPI.SP_CONTONOMEFILE");

			return i_Result;
		}

		public  int VERSIONEREPORTKPI(string mese, string anno)
		{
			S_ControlsCollection CollezioneControlli=new S_ControlsCollection();
			...
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_KPI.SP_VERVERSIONEFILE");

			return i_Result;
		}

		public  int INSREPORTKPI(S_ControlsCollection CollezioneControlli)
		{
			...
			s_p_CurrentUser.Index = CollezioneControlli.Count;
			...
			i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_KPI.SP_INSREPORTKPI");

			return i_Result;
		}

		public  DataSet GetREPORTKPI(S_ControlsCollection CollezioneControlli)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_KPI.GETREPORTKPI";	
			DataSet _Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
