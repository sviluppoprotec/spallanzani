...
namespace TheSite.Classi.AnagrafeImpianti
{
	...
	public class DataRoom
	{
		...
		public DataSet DatiTestata(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;		
			...
			string s_StrSql = "PACK_APPARECCHIATURE.sp_dati_stanza";	
		...
		public DataSet RicercaApparecchiaturaPerStanza_str(S_ControlsCollection CollezioneControlli)
		{
			DataSet _Ds;		
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_APPARECCHIATURE.SP_GETAPPERSTANZA_STR";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
