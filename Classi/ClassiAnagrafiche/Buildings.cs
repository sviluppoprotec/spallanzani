...
//			}
			...
			{			
				...
				ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
				string s_StrSql = "PACK_BUILDINGS.SP_GETALLBUILDINGSSTANZE";	
				_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
			...
			public  DataSet GetDataStanze(S_ControlsCollection CollezioneControlli)
			{
				DataSet _Ds;
				...
				ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
				string s_StrSql = "PACK_BUILDINGS.SP_RICERCASTANZA";	
				_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			

				return _Ds;		
			}

			public  int GetDataStanzeCount(S_ControlsCollection CollezioneControlli)
			{
				DataSet _Ds;
				...
				ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
				string s_StrSql = "PACK_BUILDINGS.SP_RICERCASTANZACount";	
				_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();		
			...
			public DataSet GetReport(int TipoReport, int bl_id)
			{
				...
				string s_StrSql ="";
				if(TipoReport==0)
					s_StrSql ="PACK_BUILDINGS.SP_RP1";
				if(TipoReport==1)
					s_StrSql ="PACK_BUILDINGS.SP_RP2";
				if(TipoReport==2)
					s_StrSql ="PACK_BUILDINGS.SP_RP3";
				if(TipoReport==3)
					s_StrSql ="PACK_BUILDINGS.SP_RP4";
				if(TipoReport==4)
					s_StrSql ="PACK_BUILDINGS.SP_RP5";
...
//			}
			...
			public DataSet GetAllPianiRICERCASPAZI()
			{
				DataSet _Ds;
				...
				ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
				string s_StrSql = "PACK_BUILDINGS.SP_GETPIANIRICERCASPAZI";	
				_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
