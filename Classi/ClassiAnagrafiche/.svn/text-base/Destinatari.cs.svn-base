...
namespace TheSite.Classi.ClassiAnagrafiche
{
	...
	/// </summary>
	public class Destinatari: AbstractBase
	{
		public Destinatari()
		{
			//
		...
		public override DataSet GetData(S_ControlsCollection CollezioneControlli)
		{
			...
			string s_StrSql = "PACK_DETINATARIINVIO.SP_RICERCADESTINATARI";
		...
		public DataSet GetServizi(int id_bl)
		{
			DataSet _Ds;
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_DETINATARIINVIO.SP_GETSERVIZI";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		{		
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_DETINATARIINVIO.SP_DELETEDEST");
		...
		protected override int ExecuteUpdate(S_ControlsCollection CollezioneControlli, ExecuteType Operazione, int itemId)
		{
			...
			s_IdIn.ParameterName = "v_id_destinatari_doc";
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_DETINATARIINVIO.SP_UPDATEDEST");
