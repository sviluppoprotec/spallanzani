...
namespace TheSite.Classi.ClassiAnagrafiche
{
	...
	public class ListaMateriali : AbstractBase
	{
		...
		public override DataSet GetData()
		{
			...
			string s_StrSql = "PACK_MATERIALI.SP_GETALLMATERIALI";
		...
		public override DataSet GetSingleData(int itemId)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);	
			string s_StrSql = "PACK_MATERIALI.SP_GETSINGLEMATERIALI";	
		...
		public  DataSet GetMagazzino()
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_MATERIALI.SP_ALLMAGAZZINO";	
			_Ds = _OraDl.GetRows(_SColl, s_StrSql).Copy();			
		...
		protected override int ExecuteUpdate(S_ControlsCollection CollezioneControlli, ExecuteType Operazione, int itemId)
		{
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_MATERIALI.SP_EXECUTEMATERIALI");
