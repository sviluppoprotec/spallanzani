<%@ Page language="c#" Codebehind="IndiceSoddifazione.aspx.cs" AutoEventWireup="false" Inherits="TheSite.SoddisfazioneCliente.IndiceSoddifazione" %>
...
<TABLE id=TableMain 
style="Z-INDEX: 101; LEFT: 0px; WIDTH: 100%; POSITION: absolute; TOP: 0px" 
cellSpacing=0 cellPadding=0 align=center border=0>
  ...
  <TR>
    <TD vAlign=top align=center width="100%">
      <TABLE id=tblForm style="WIDTH: 100%" cellSpacing=1 cellPadding=1 
      align=center border=0>
        <TBODY>
        <TR>
          <TD vAlign=top width="100%"><COLLAPSE:DATAPANEL 
            id=PanelRicerca runat="server" 
            ...
            <TABLE style="WIDTH: 100%">
              ...
              <TR>
                <TD style="WIDTH: 100%" colSpan=4>
                  <TABLE id=TableRicercaModulo style="WIDTH: 100%" cellSpacing=1 
                  cellPadding=1 border=0>
                    <TR>
                      <TD><UC1:RICERCAMODULO id=RicercaModulo1 runat="server"></UC1:RICERCAMODULO></TD></TR></TABLE></TD></TR>
              <TR>
                <TD colSpan=4>
              ...
              <TR>
                <TD align=center colSpan=4><ASP:PANEL 
                  id=PanelServizio runat="server">
                  <TABLE class=tblSearch100Dettaglio id=Table2 
...
<CC1:S_COMBOBOX id=cmbsServizio runat="server" width="280px" dbsize="4" dbindex="10" autopostback="True" dbdatatype="Integer" dbparametername="p_Servizio_Id"></CC1:S_COMBOBOX></TD>
                      <TD style="HEIGHT: 16px">Indice Soddisfazione</TD>
                      <TD style="HEIGHT: 16px" align=left width="40%">
<CC1:S_COMBOBOX id=cmbsIndice runat="server" width="280px" dbsize="4" dbindex="10" autopostback="False" dbdatatype="VarChar" DBDirection="ReturnValue">
...
<CC1:S_COMBOBOX id=cmbsTipoGiudizio runat="server" width="152px" dbsize="4" dbindex="10" dbdatatype="Integer">
<asp:ListItem Value="F">A Freddo</asp:ListItem>
<asp:ListItem Value="C" Selected="True">A Caldo</asp:ListItem>
</CC1:S_COMBOBOX></TD></TR></TABLE></ASP:PANEL></TD></TR>
              <TR>
                <TD colSpan=4>&nbsp;</TD></TR>
              <TR>
...
<CC1:S_BUTTON id=cmdExcel tabIndex=2 runat="server" cssclass="btn" text="Esporta"></CC1:S_BUTTON><CC1:S_BUTTON id=btnReset tabIndex=5 runat="server" cssclass="btn" text="Reset"></CC1:S_BUTTON>&nbsp;</TD>
                <TD align=right><A class=GuidaLink 
                  ...
                  >Guida</A> 
        </TD></TR></TR></TBODY></TABLE></TD></TR></COLLAPSE:DATAPANEL></TD></TR>
        <TR>
          <TD align=center><UC1:GRIDTITLE id=GridTitle1 runat="server" visible="False"></UC1:GRIDTITLE><ASP:DATAGRID id=DataGridRicerca runat="server" cssclass="DataGrid" allowpaging="True" gridlines="Vertical" autogeneratecolumns="False" borderwidth="1px" bordercolor="Gray" PageSize="25">
...
<asp:BoundColumn DataField="rc" HeaderText="N&#176; Reclami">
<ItemStyle HorizontalAlign="Center" Width="80px">
</ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="D" HeaderText="N&#176; Giudizi">
<ItemStyle HorizontalAlign="Center" Width="80px">
</ItemStyle>
</asp:BoundColumn>
<asp:BoundColumn DataField="indicesoddisfazione" HeaderText="Indice Soddisfazione">
<ItemStyle HorizontalAlign="Center" Width="80px">
</ItemStyle>
</asp:BoundColumn>
...
</ASP:DATAGRID></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></FORM>
