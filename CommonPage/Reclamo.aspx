<%@ Page language="c#" Codebehind="Reclamo.aspx.cs" AutoEventWireup="false" Inherits="TheSite.CommonPage.Reclamo" %>
...
<HTML>
	<HEAD>
		...
		function Chiudi()
		{
			var oVDiv=parent.document.getElementById("addReclamo").style;
			oVDiv.display = 'none';
		}
					...
					<TD>
						...
						<P>
							<TABLE id="tblSearch100" border="0">
								...
								<TR>
									<TD align="left">&nbsp;
										<cc1:s_button id="btnsAggiungi" tabIndex="4" runat="server" Text="Aggiungi Reclamo" Width="150px"></cc1:s_button></TD>
								</TR>
							</TABLE>
						</P>
					</TD>
