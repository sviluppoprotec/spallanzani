...
<%@ Page language="c#" Codebehind="ChiariInfo.aspx.cs" AutoEventWireup="false" Inherits="TheSite.CommonPage.ChiariInfo" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>Chiarimenti Informazioni</title>
		...
		function Chiudi()
		{
			var oVDiv=parent.document.getElementById("addChiariInfo").style;
			oVDiv.display = 'none';
		}
					...
					<TD>
						...
						<P>
							<TABLE id="tblSearch100" border="0">
								<tr>
									<td><asp:panel id="PanelEdit" runat="server" Height="56px" Width="100%">
											<TABLE width="100%">
												<TR>
													<TD colSpan="2">
														<uc1:RichiedentiSollecito id="RichiedentiSollecito1" runat="server"></uc1:RichiedentiSollecito></TD>
												<TR>
													<TD align="left">Informazioni-Chiarimenti</TD>
													<TD>
														<cc1:S_TextBox id="txtsMotivo" runat="server" Width="500px" DBSize="4000" DBDirection="Input" DBParameterName="p_Motivo"
															DBIndex="3"></cc1:S_TextBox></TD>
												</TR>
											</TABLE>
										</asp:panel></td>
								</tr>
								<TR>
									<TD align="left">&nbsp;
										<cc1:s_button id="btnsAggiungi" tabIndex="4" runat="server" Text="Aggiungi  Informazione-Chiarimento"
											Width="216px"></cc1:s_button></TD>
								</TR>
							</TABLE>
						</P>
					</TD>
