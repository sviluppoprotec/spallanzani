...
{
	/// <summary>
	/// Descrizione di riepilogo per Reclamo.
	/// </summary>
	public class Reclamo : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			this.Button1.Attributes.Add("onclick","return ControllaRichiedente('" +  RichiedentiSollecito1.s_RichNome.ClientID + "','" + RichiedentiSollecito1.s_RichCognome.ClientID + "')");
