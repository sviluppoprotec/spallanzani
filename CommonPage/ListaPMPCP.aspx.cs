...
namespace TheSite.CommonPage
{
	...
	/// </summary>
	public class ListaPMPCP : System.Web.UI.Page
	{
		...
		private void Execute()
		{
			...
			Classi.GestioneCP.SfogliaRdlOdl  _CP = new Classi.GestioneCP.SfogliaRdlOdl(Context.User.Identity.Name);		
			
			S_Controls.Collections.S_Object s_P_desc = new S_Controls.Collections.S_Object();
			s_P_desc.ParameterName = "P_desc";
			s_P_desc.DbType = CustomDBType.VarChar;
			s_P_desc.Direction = ParameterDirection.Input;
			s_P_desc.Index = 0;
			s_P_desc.Size=250;
			s_P_desc.Value = this.idric;			
			CollezioneControlli.Add(s_P_desc);

			DataSet Ds = _CP.GetPMPCP(CollezioneControlli);
