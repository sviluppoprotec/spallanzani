...
//		}
		...
		private void DataGrid1_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
				...
				(e.Item.ItemType == ListItemType.AlternatingItem))
			{
				...
				string prezzo = e.Item.Cells[2].Text.Split(';')[2];
				if(prezzo.Substring(0,1).Equals(","))
					prezzo = "0"+prezzo;

				string funzioneJsCmbValue = "Popola2('"	+ e.Item.Cells[1].Text + "','"+prezzo+"','"	+ e.Item.Cells[3].Text + "');";
				//	cmbMateriali.Attributes.Add("onchange",funzioneJsCmbValue);
				

				((HtmlAnchor)e.Item.FindControl("hrefset")).HRef="javascript:Popola2('"	+ e.Item.Cells[1].Text + "','"+prezzo+"','"	+ e.Item.Cells[3].Text + "');";
  
				e.Item.Cells[4].Text=e.Item.Cells[2].Text.Split(';')[1]+" / "+prezzo+" €";
