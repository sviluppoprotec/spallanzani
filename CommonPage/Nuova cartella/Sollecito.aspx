					...
					<TD>
						...
						<P>
							<TABLE id="tblSearch100" border="0">
									...
									<td><asp:panel id="PanelEdit" runat="server" Height="56px" Width="100%">
											<TABLE width="100%">
												...
												<TR>
													...
													<TD>
														<cc1:S_TextBox id="txtsMotivo" runat="server" Width="270px" DBIndex="3" DBParameterName="p_Motivo"
															DBDirection="Input" DBSize="4000"></cc1:S_TextBox></TD>
												</TR>
											</TABLE>
										</asp:panel></td>
								</tr>
								<TR>
									<TD align="left">&nbsp;
										<cc1:s_button id="btnsAggiungi" tabIndex="4" runat="server" Text="Aggiungi"></cc1:s_button>
										<asp:label style="Z-INDEX: 0" id="lbloperazione" runat="server" Font-Bold="True"></asp:label></TD>
								</TR>
							</TABLE>
						</P>
					</TD>
