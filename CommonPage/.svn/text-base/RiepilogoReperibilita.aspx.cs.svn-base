...
//			{
				...
				// se vengo chiamato da gestione avvisi ...
				if(Request.QueryString["avvisi"]!=null)
				{
					HyperLink1.Visible=false;
					HyperLinkChiudi2.Visible=false;		
					MyDataGrid1.PageSize=20;
				}
				else
				{
					HyperLink1.Visible=true;
					HyperLinkChiudi2.Visible=true;		
					MyDataGrid1.PageSize=5;
				}
