				...
				<tr>
					<td vAlign="middle">
						<div align="center"><asp:requiredfieldvalidator id="rfvconferma" runat="server" CssClass="LabelErrore" ControlToValidate="txtsConfermaPasword"
							...
							<table style="BORDER-BOTTOM: slategray 1px outset; BORDER-LEFT: slategray 1px outset; WIDTH: 346px; HEIGHT: 311px; BORDER-TOP: slategray 1px outset; BORDER-RIGHT: slategray 1px outset"
