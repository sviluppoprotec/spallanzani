namespace GIC.Report.UserControl
{
	...
	public class VisSelCampi : App_Code.BaseControl
	{
		...
		{			
			...
			{
				string scriptString;
				scriptString= "<script language=\"JavaScript\">alert('Errore imprevisto ripetere comando');<";
				scriptString += "/";
				scriptString += "script>";
				this.Page.RegisterStartupScript("Startup2", scriptString);
				return;
				
				
				//e.ToString();
//				string scriptString;
//				scriptString= "<script language=\"JavaScript\">alert('Cliccare una sola volta sul link');<";
//				scriptString += "/";
//				scriptString += "script>";
