...
namespace GIC.App_Code
{
	...
	public class BasePage: System.Web.UI.Page
	{
		...
		{
			get { return (string)ViewState["Colonna"];}
			set 
			{ 
				if (ViewState["Colonna"]!=null)
				{
					string sortcolumn=(string)ViewState["Colonna"];
					string newsortcolumn= value + " desc";
					if (sortcolumn==newsortcolumn)
					{
						ViewState["Colonna"]=value + " asc";
						return;
					}
					newsortcolumn= value + " desc";
					if (sortcolumn==newsortcolumn)
					{
						ViewState["Colonna"]=value + " desc";
						return;
					}
					ViewState["Colonna"]=value + " desc";
				}			
