		...
		<form id="Form1" method="post" runat="server">
			<asp:panel id="PanelPannelloRicerca" runat="server" Width="100%" Height="59px"> <!-- Pannello di ricerca -->
									...
									<TR vAlign="top">
										<TD align="center">
											<TABLE style="HEIGHT: 95px" id="tabl" class="tblSearch100Dettaglio" border="0" cellSpacing="0"
												...
												<TR>
													<TD style="WIDTH: 158px; HEIGHT: 26px"><SPAN>Macroarea:</SPAN></TD>
													<TD style="HEIGHT: 26px">
														<cc1:S_ComboBox id="cmbsCategoria" runat="server" Width="392px"></cc1:S_ComboBox></TD>
												</TR>
												<TR>
													<TD style="WIDTH: 158px; HEIGHT: 20px">Destinazione uso:</TD>
													<TD style="HEIGHT: 20px">
														<cc1:S_TextBox id="s_txtDestinazione" runat="server" Width="344px"></cc1:S_TextBox>&nbsp;<INPUT style="WIDTH: 32px; HEIGHT: 25px" id=bt_destinazione class=btn onclick="apri_ricerca_uso('ADMIN','<%= descUso1 %>','<%= Usoid1 %>');" value=... type=button name=bt_destinazione></TD>
												</TR>
												<TR>
													<TD style="WIDTH: 158px; HEIGHT: 27px">Reparto:</TD>
													<TD style="HEIGHT: 27px">
														<cc1:S_TextBox id="s_txtReparto" runat="server" Width="344px"></cc1:S_TextBox>&nbsp;<INPUT style="WIDTH: 32px; HEIGHT: 25px" id=bt_reparto class=btn onclick="apri_ricerca_reparto('ADMIN','<%= descRep%>','<%= id%>');" value=... type=button name=bt_reparto></TD>
												</TR>
												<TR>
												...
												<TR>
													<TD style="HEIGHT: 4px" colSpan="2" align="center">&nbsp; Edifici Selezionati <EM>(Fare 
												...
												<TR>
													<TD colSpan="2" align="left">
														<TABLE style="WIDTH: 448px; HEIGHT: 19px" id="Table1" border="0" cellSpacing="0" cellPadding="0"
															width="448">
															<TR>
																<TD align="right">&nbsp;</TD>
				...
				<TABLE id="tblSearch102" border="0" cellSpacing="1" cellPadding="1" width="100%">
					<TR>
						<TD width="10%" align="right"><IMG src="../Images/Pie.png">&nbsp;</TD>
						...
						<TD width="7%" align="center">&nbsp;<IMG src="../Images/Pie.png"></TD>
						<TD width="26%" align="left">
							<CC1:S_OPTIONBUTTON id="S_Categorie" tabIndex="5" runat="server" groupname="Grkind" text="Grafico della Superficie Utile per Macroarea"></CC1:S_OPTIONBUTTON></TD>
					</TR>
					<TR>
						<TD width="10%" align="right"><IMG src="../Images/GraficiIstogramma.png">&nbsp;</TD>
						<TD width="20%" align="left">
						...
						<TD width="7%" align="center"><IMG src="../Images/GraficiIstogramma.png">&nbsp;</TD>
						<TD width="26%" align="left">
					...
					<TR>
						<TD colSpan="6" align="center">
							<TABLE id="tblSubmit" border="0" cellSpacing="1" cellPadding="1" width="20%" align="center">
								<TR>
									...
									<TD noWrap align="left"><INPUT style="WIDTH: 150px" id="Reset1" class="btn" tabIndex="10" value="Reset" type="reset"
