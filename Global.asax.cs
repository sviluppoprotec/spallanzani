	...
	public class Global : System.Web.HttpApplication
	{
		...
		protected void Application_Error(Object sender, EventArgs e)
		{
			try
			{
				...
				//				SmtpMail.Send(msg1);
				string Namefile= System.DateTime.Now.Year.ToString() + 
					System.DateTime.Now.Month.ToString().PadLeft(2,Convert.ToChar("0")) +
					System.DateTime.Now.Day.ToString().PadLeft(2,Convert.ToChar("0")) +
					System.DateTime.Now.Hour.ToString().PadLeft(2,Convert.ToChar("0"))  + 
					System.DateTime.Now.Minute.ToString().PadLeft(2,Convert.ToChar("0")) +
					System.DateTime.Now.Second.ToString().PadLeft(2,Convert.ToChar("0")); 
