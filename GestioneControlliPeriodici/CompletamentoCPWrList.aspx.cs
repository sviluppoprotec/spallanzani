...
{
////	/// <summary>
////	/// Descrizione di riepilogo per CompletamentoCPWrList.
////	/// </summary>
////	public class CompletamentoCPWrList_prima : System.Web.UI.Page
////	{
...
////	/// Descrizione di riepilogo per Completamento_MP_WRList.
	/// </summary>   Completamento_MP_WRList1
	public class CompletamentoCPWrList : System.Web.UI.Page
	{
		protected System.Web.UI.WebControls.DataGrid DataGridRicerca;
		protected S_Controls.S_Button btnsCompletaOdl;
		protected System.Web.UI.WebControls.Label Label1;
		...
		private void btnsCompletaOdl_Click(object sender, System.EventArgs e)
		{
			...
			scriptString += "window.returnValue =window.showModalDialog(\"Completa_WO1.aspx?wo=" + LblODL.Text + "&data=" + CalendarPicker1.Datazione.Text + "&data1=" + CalendarPicker2.Datazione.Text +  "\", \"dial\",\"" + feature + "\")\n";
			...
			if (_HS.Count==0)
				...
				Classi.SiteJavaScript.WindowOpen(this.Page,0,"Completa_WO1.aspx?wo=" + LblODL.Text + "&data=" + CalendarPicker1.Datazione.Text+"&data1=" + CalendarPicker2.Datazione.Text ,800,600,"dettaglio");
