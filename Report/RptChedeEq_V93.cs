...
namespace TheSite.Report {
    ...
    public class RptChedeEq_V9 : ReportClass {
        
        public RptChedeEq_V9() {
        }
        ...
        public override string FullResourceName {
            get {
                return "TheSite.Report.RptChedeEq_V9.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRptChedeEq_V9 : Component, ICachedReport {
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            RptChedeEq_V9 rpt = new RptChedeEq_V9();
            rpt.Site = this.Site;
            return rpt;
        }
