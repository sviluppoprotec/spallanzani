	...
	<HEAD>
		...
		<script language="javascript">
					function openallegati(namefile)
					{
						...
						url = "VisualDWF.aspx?var_afm_dwgs_dwg_name=" +namefile  ;											
						//alert(url);
					...
					<TR vAlign="top">
						<TD vAlign="top"><asp:datagrid id="MyDataGrid1" runat="server" GridLines="Vertical" AllowPaging="False" CssClass="DataGrid"
								...
								<Columns>
									...
									<asp:TemplateColumn HeaderText="Visualizza File ">
										<HeaderStyle Width="5%"></HeaderStyle>
										<ItemTemplate>
											<!--<asp:HyperLink id="Hyperlink1" runat="server" 
											Text='<%# DataBinder.Eval(Container.DataItem, "NOMEFILE") %>' NavigateUrl=<%# "javascript:openallegati("+ "'" + DataBinder.Eval(Container.DataItem, "nomefile") + "'" + " );"%> >
											</asp:HyperLink>-->
											<asp:ImageButton ImageUrl="../Images/attach.png" Runat=server OnCommand="imageButton_Click" CommandArgument='<%# DataBinder.Eval(Container.DataItem,"var_afm_dwgs_dwg_name") %>' ID="Imagebutton1">
											</asp:ImageButton>
