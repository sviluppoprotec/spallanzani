...
namespace WebCad.Classi.ClassiAnagrafiche
{
	...
	public class Contatti : AbstractBase
	{
		...
		public DataSet GetData(int itemId)
		{
			...
			string s_StrSql = "PACK_CONTATTI.SP_GETCONTATTI";	
		...
		protected override int ExecuteUpdate(S_ControlsCollection CollezioneControlli, ExecuteType Operazione, int itemId)
		{
			...
			s_IdIn.ParameterName = "p_idContatto";
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_CONTATTI.SP_EXECUTECONTATTI");
