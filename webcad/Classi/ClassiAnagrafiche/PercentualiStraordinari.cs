...
namespace WebCad.Classi.ClassiAnagrafiche
{
	...
	{
		public PercentualiStraordinari() {}
		...
		public override DataSet GetData(S_ControlsCollection CollezioneControlli)
		{
			...
			string s_StrSql = "PACK_ADDETTI.SP_GETPERCENTUALISTRAORDINARI";
		...
		public override DataSet GetSingleData(int itemId)
		{
			...
			ApplicationDataLayer.OracleDataLayer _OraDl = new OracleDataLayer(s_ConnStr);
			string s_StrSql = "PACK_ADDETTI.SP_GETSINGLEPERCENTUALISTRAORD";	
			_Ds = _OraDl.GetRows(CollezioneControlli, s_StrSql).Copy();			
		...
		protected override int ExecuteUpdate(S_ControlsCollection CollezioneControlli, ExecuteType Operazione, int itemId)
		{
			...
			int i_Result = _OraDl.GetRowsAffected(CollezioneControlli, "PACK_ADDETTI.SP_EXECUTEPERCENTUALISTRAORD");
