<%@ Page language="c#" Codebehind="CompletamentoMP1.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneProgrammata.CompletamentoMP1" %>
...
style="Z-INDEX: 101; POSITION: absolute; TOP: 0px; LEFT: 0px" cellPadding=0 
...
<cc1:S_Button style="Z-INDEX: 0" id=btnSChiudi runat="server" CssClass="btn" Width="98px" Text="INDIETRO"></cc1:S_Button>&nbsp; 
                  <INPUT type=hidden name=hidRicerca></TD>
                <TD align=right><A class=GuidaLink href="<%= HelpLink %>" 
                  target=_blank>Guida</A></TD></TR></TABLE><INPUT id=txtHidden 
            value=0 type=hidden></COLLAPSE:DATAPANEL></TD></TR>
        <tr>
...
<ItemTemplate>
<asp:LinkButton CommandName="Dettaglio" Text='<%# DataBinder.Eval(Container.DataItem,"ID") %>' CommandArgument= '<%# "Completamento_MP_WRlist1.aspx?wo_id=" + DataBinder.Eval(Container.DataItem,"ID")%>' runat="server" ID="Linkbutton1"/>
...
<PagerStyle Mode="NumericPages">
        ...
        <TR>
          	<td><COLLAPSE:DATAPANEL id="DatapanelCompleta" runat="server" TitleStyle-CssClass="TitleSearch" CssClass="DataPanel75"
												...
												Visible="False">
            <TABLE style="WIDTH: 937px; HEIGHT: 190px" border=1 align=center 
            height=190>
              <TBODY>
              <TR>
                <TD style="WIDTH: 378px">
                  <TABLE>
                    ...
                    <TR>
                      <TD 
                        style="WIDTH: 102px; HEIGHT: 21px; COLOR: red">Modifica 
                        Addetto</TD>
...
<cc1:S_Button id=btnsModificaODL runat="server" CssClass="btn" Width="98px" Text="MODIFICA ODL"></cc1:S_Button></TD></TR></TABLE></TD></TR>
              <TR>
                <TD colSpan=2 
            align=center></COLLAPSE:DATAPANEL></td></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></TBODY></TABLE></TD></TR></form></TR></TBODY></TABLE></TR></TBODY></TABLE></TR></TBODY></TABLE></FORM>
