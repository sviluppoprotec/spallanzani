...
namespace TheSite.ManutenzioneProgrammata
{
	...
	public class SfogliaOdlRdl : System.Web.UI.Page
	{
		...
		Completamento_MP_WRList1 _fp1=null;
...
//			this.DataGrid1.Columns[1].Visible = _SiteModule.IsEditable;												
			...
			if(!IsPostBack)
			{
			  ...
			  BindControls();
				...
				if(Context.Handler is TheSite.ManutenzioneProgrammata.Completamento_MP_WRList1)
				{
					_fp1 = (TheSite.ManutenzioneProgrammata.Completamento_MP_WRList1)Context.Handler;
					if (_fp1!=null) 
					{						
		...
		private void BindStdApparecchiatura()
		{
			...
			if (_MyDs.Tables[0].Rows.Count > 0)
			{
				this.cmbsStdApparecchiature.DataSource = Classi.GestoreDropDownList.ItemBlankDataSource(
					_MyDs.Tables[0], "DESCRIZIONE", "ID", "- Selezionare uno Standard Apparecchiatura -", "");
			...
			{
				string s_Messagggio = "- Nessun Standard Apparecchiatura -";
...
//			// Apparecchiature				
		...
		private void DataGrid1_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			if( e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem )
			{
				...
				System.Web.UI.WebControls.ImageButton imb= (ImageButton) e.Item.Cells[12].FindControl("btScarica");
				
				if (DataBinder.Eval(e.Item.DataItem, "name_file")!=System.DBNull.Value) 
				{					
					imb.Visible = true;					
				}
				else
		...
		public void LinkButton2_Click(object sender, CommandEventArgs e)
		{
			...
			Server.Transfer("Completamento_MP_WRList1.aspx?wo_id=" + e.CommandArgument+"&FunId="+FunId
			+"&chiamante=SfogliaOdlRdl.aspx"	
				); 

		}
		
		public void LinkButton3_Click(object sender, CommandEventArgs e)
		{
			//_myColl.AddControl(this.Page.Controls, ParentType.Page);
...
//				); 
		...
		private void DataGrid1_ItemCommand(object source, System.Web.UI.WebControls.DataGridCommandEventArgs e)
		{
			if (e.CommandName=="Download")
			{
				...
				string PathDir=Server.MapPath("../DOC_DB/WO");
			...
			if (e.CommandName=="Allega")
			{
			
			Classi.SiteJavaScript.WindowOpen(this.Page,0,"Allegawo.aspx?wo=" + e.CommandArgument.ToString()  ,400,300,"dettaglio");
