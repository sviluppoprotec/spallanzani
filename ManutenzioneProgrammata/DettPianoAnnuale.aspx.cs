	...
	public class DettPianoAnnuale : System.Web.UI.Page
	{
		...
		private void DataGridRicerca_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			{ 
				...
				if (e.Item.Cells[2].Text.Trim().Length > 150) 
				{
					descrizione=e.Item.Cells[2].Text.Trim().Substring(0,148) + "..."; 
					e.Item.Cells[2].ToolTip=e.Item.Cells[2].Text;
					e.Item.Cells[2].Text=descrizione;
				} 
				
				if (e.Item.Cells[3].Text.Trim().Length >150) 
				{
					note=e.Item.Cells[3].Text.Trim().Substring(0,148) + "..."; 
