...
namespace TheSite.ManutenzioneProgrammata
{
	...
	/// </summary>
	public class SfogliaRdlOdl_MP1 : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			if(!IsPostBack)
			{
				...
				if (Context.Items["wo_id"]!=null ||Request.QueryString["id_wo"]!=null)
				{
				    
					this.wo_id=(string)Context.Items["wo_id"];
					if (wo_id.ToString()==string.Empty)
						this.wo_id=(string)Request.QueryString["id_wo"];
					executeDatiGenerali();
					execute();
				}
			}
