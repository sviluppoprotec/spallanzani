...
<%@ Page language="c#" Codebehind="Completamento_MP_WRList1.aspx.cs" AutoEventWireup="false" Inherits="TheSite.ManutenzioneProgrammata.Completamento_MP_WRList1" %>
...
<HTML>
	<HEAD>
		...
		{
			var dataii=document.getElementById('CalendarPicker1_S_TxtDatecalendar').value; 
			var dataif=document.getElementById('CalendarPicker2_S_TxtDatecalendar').value; 
			
			
			
			if(dataii=="")
			{
			 alert("Specificare la Data inizio effettivo di Completamento/Sospensione.");
			 return false;
			}
			
			if(dataif=="")
			{
			 alert("Specificare la Data fine effettivo di Completamento/Sospensione.");
			 return false;
			}
				...
				<TBODY>
					...
					<TR>
						<TD>
								...
								<TBODY>
									<TR>
										<TD>
											<table width="100%">
												<tr align="center">
													<td colSpan="7"><b>Dati Ordine di Lavoro (ODL)</b>
													</td>
												</tr>
												<tr>
													<td style="WIDTH: 186px; HEIGHT: 14px"><asp:label id="Label1" runat="server" Font-Bold="True" ForeColor="Gray">Ordine di Lavoro</asp:label></td>
													<td style="WIDTH: 186px; HEIGHT: 14px"><asp:label id="Label3" runat="server" Font-Bold="True" ForeColor="Gray">Edificio</asp:label></td>
													<td style="WIDTH: 186px; HEIGHT: 14px"><asp:label id="Label5" runat="server" Font-Bold="True" ForeColor="Gray">Data Emissione ODL</asp:label></td>
													<td style="WIDTH: 186px; HEIGHT: 14px"><asp:label id="Label6" runat="server" Font-Bold="True" ForeColor="Gray">Data Schedulazione</asp:label></td>
													<td style="WIDTH: 186px; HEIGHT: 14px"><asp:label id="Label7" runat="server" Font-Bold="True" ForeColor="Gray">Ditta</asp:label></td>
													<td style="WIDTH: 186px; HEIGHT: 14px"><asp:label id="Label2" runat="server" Font-Bold="True" ForeColor="Gray">Addetto</asp:label></td>
												</tr>
												<tr>
													<td style="WIDTH: 186px">&nbsp;
														<asp:label id="LblODL" runat="server"></asp:label></td>
													<td style="WIDTH: 186px">&nbsp;
														<asp:label id="LblCodEdificio" runat="server"></asp:label></td>
													<td style="WIDTH: 186px">&nbsp;
														<asp:label id="LblDataEmissione" runat="server"></asp:label></td>
													<TD style="WIDTH: 186px">&nbsp;
													...
													<TR>
														<TD style="WIDTH: 378px">
															<TABLE border="1" width="100%">
																...
																<TR>
																	<TD style="HEIGHT: 28px" align="center">Addetto</TD>
																	<TD style="HEIGHT: 28px" align="center">
																		<cc1:S_ComboBox id="cmbsAddetto" runat="server" DBSize="5" DBDirection="Input" DBParameterName="p_Addetto"
																			DBIndex="5" DBDataType="Integer" AutoPostBack="False" Width="384px"></cc1:S_ComboBox></TD>
																</TR>
																<TR>
																	<TD style="HEIGHT: 28px" align="center">Inizio Schedulato</TD>
																	<TD style="HEIGHT: 28px" align="center">
																		<uc1:calendarpicker id="Calendarpicker3" runat="server" Visible="True"></uc1:calendarpicker></TD>
																</TR>
																<TR>
																	<TD style="HEIGHT: 28px" align="center">Fine Schedulato</TD>
																	<TD style="HEIGHT: 28px" align="center">
																...
																<TR>
																	<TD width="50%" align="right">
																		<cc1:s_button id="btnsCompletaOdl" runat="server" CssClass="btn" Visible="False" Width="100%"
																			Text="COMPLETA ODL"></cc1:s_button></TD>
																	<TD align="left">
							...
							<INPUT id="hiddenreload" type="hidden" name="hiddenreload" runat="server">
